...
public sealed partial class PutDataLifecycleRequest : PlainRequest<PutDataLifecycleRequestParameters>, ISelfTwoWaySerializable
{
	...
	{
		Lifecycle = settings.RequestResponseSerializer.Deserialize<Elastic.Clients.Elasticsearch.Serverless.IndexManagement.DataStreamLifecycle>(ref reader);
	}
}
...
public sealed partial class PutDataLifecycleRequestDescriptor : RequestDescriptor<PutDataLifecycleRequestDescriptor, PutDataLifecycleRequestParameters>
{
	...
	public PutDataLifecycleRequestDescriptor Lifecycle(Action<Elastic.Clients.Elasticsearch.Serverless.IndexManagement.DataStreamLifecycleDescriptor> configure)
	{
		LifecycleValue = null;
		LifecycleDescriptor = null;
