...
internal sealed partial class PutMappingRequestConverter : System.Text.Json.Serialization.JsonConverter<PutMappingRequest>
{
	...
	public override PutMappingRequest Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<bool?> propDateDetection = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Mapping.DynamicMapping?> propDynamic = default;
		LocalJsonProperty<ICollection<string>?> propDynamicDateFormats = default;
		LocalJsonProperty<ICollection<IDictionary<string, Elastic.Clients.Elasticsearch.Serverless.Mapping.DynamicTemplate>>?> propDynamicTemplates = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Mapping.FieldNamesField?> propFieldNames = default;
		LocalJsonProperty<IDictionary<string, object>?> propMeta = default;
		LocalJsonProperty<bool?> propNumericDetection = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Mapping.Properties?> propProperties = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Mapping.RoutingField?> propRouting = default;
		LocalJsonProperty<IDictionary<Elastic.Clients.Elasticsearch.Serverless.Field, Elastic.Clients.Elasticsearch.Serverless.Mapping.RuntimeField>?> propRuntime = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Mapping.SourceField?> propSource = default;
		while (reader.Read() && reader.TokenType is System.Text.Json.JsonTokenType.PropertyName)
		{
			...
			if (propDynamicTemplates.TryRead(ref reader, options, PropDynamicTemplates, typeof(SingleOrManyMarker<IReadOnlyCollection<IReadOnlyDictionary<string, Elastic.Clients.Elasticsearch.Serverless.Mapping.DynamicTemplate>>?, IReadOnlyDictionary<string, Elastic.Clients.Elasticsearch.Serverless.Mapping.DynamicTemplate>>)))
			{
				continue;
			}
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, PutMappingRequest value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		writer.WriteProperty(options, PropDynamicTemplates, value.DynamicTemplates, typeof(SingleOrManyMarker<IReadOnlyCollection<IReadOnlyDictionary<string, Elastic.Clients.Elasticsearch.Serverless.Mapping.DynamicTemplate>>?, IReadOnlyDictionary<string, Elastic.Clients.Elasticsearch.Serverless.Mapping.DynamicTemplate>>));
