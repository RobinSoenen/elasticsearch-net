...
internal sealed partial class DeleteIndexResponseConverter : System.Text.Json.Serialization.JsonConverter<DeleteIndexResponse>
{
	...
	public override DeleteIndexResponse Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, DeleteIndexResponse value, System.Text.Json.JsonSerializerOptions options)
	{
...
[JsonConverter(typeof(DeleteIndexResponseConverter))]
