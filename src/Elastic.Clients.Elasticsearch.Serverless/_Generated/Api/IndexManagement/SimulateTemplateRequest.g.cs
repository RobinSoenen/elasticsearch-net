...
public sealed partial class SimulateTemplateRequestDescriptor<TDocument> : RequestDescriptor<SimulateTemplateRequestDescriptor<TDocument>, SimulateTemplateRequestParameters>
{
	...
	public SimulateTemplateRequestDescriptor(Elastic.Clients.Elasticsearch.Serverless.Name? name) : base(r => r.Optional("name", name))
	{
	}
	...
	public SimulateTemplateRequestDescriptor<TDocument> MasterTimeout(Elastic.Clients.Elasticsearch.Serverless.Duration? masterTimeout) => Qs("master_timeout", masterTimeout);

	public SimulateTemplateRequestDescriptor<TDocument> Name(Elastic.Clients.Elasticsearch.Serverless.Name? name)
	{
	...
	/// </para>
	/// </summary>
	public SimulateTemplateRequestDescriptor<TDocument> ComposedOf(ICollection<Elastic.Clients.Elasticsearch.Serverless.Name>? composedOf)
	{
	...
	/// </para>
	/// </summary>
	public SimulateTemplateRequestDescriptor<TDocument> DataStream(Elastic.Clients.Elasticsearch.Serverless.IndexManagement.DataStreamVisibility? dataStream)
	{
	...
	public SimulateTemplateRequestDescriptor<TDocument> DataStream(Elastic.Clients.Elasticsearch.Serverless.IndexManagement.DataStreamVisibilityDescriptor descriptor)
	{
	...
	public SimulateTemplateRequestDescriptor<TDocument> DataStream(Action<Elastic.Clients.Elasticsearch.Serverless.IndexManagement.DataStreamVisibilityDescriptor> configure)
	{
		DataStreamValue = null;
		DataStreamDescriptor = null;
	...
	/// </para>
	/// </summary>
	public SimulateTemplateRequestDescriptor<TDocument> IndexPatterns(Elastic.Clients.Elasticsearch.Serverless.Indices? indexPatterns)
	{
	...
	/// </para>
	/// </summary>
	public SimulateTemplateRequestDescriptor<TDocument> Template(Elastic.Clients.Elasticsearch.Serverless.IndexManagement.IndexTemplateMapping? template)
	{
	...
	public SimulateTemplateRequestDescriptor<TDocument> Template(Elastic.Clients.Elasticsearch.Serverless.IndexManagement.IndexTemplateMappingDescriptor<TDocument> descriptor)
	{
		TemplateValue = null;
		TemplateDescriptorAction = null;
	...
	public SimulateTemplateRequestDescriptor<TDocument> Template(Action<Elastic.Clients.Elasticsearch.Serverless.IndexManagement.IndexTemplateMappingDescriptor<TDocument>> configure)
	{
		TemplateValue = null;
		TemplateDescriptor = null;
...
public sealed partial class SimulateTemplateRequestDescriptor : RequestDescriptor<SimulateTemplateRequestDescriptor, SimulateTemplateRequestParameters>
{
	...
	/// </para>
	/// </summary>
	public SimulateTemplateRequestDescriptor ComposedOf(ICollection<Elastic.Clients.Elasticsearch.Serverless.Name>? composedOf)
	{
		ComposedOfValue = composedOf;
		return Self;
	}
	...
	/// </para>
	/// </summary>
	public SimulateTemplateRequestDescriptor DataStream(Elastic.Clients.Elasticsearch.Serverless.IndexManagement.DataStreamVisibility? dataStream)
	{
		DataStreamDescriptor = null;
		DataStreamDescriptorAction = null;
		DataStreamValue = dataStream;
	...
	public SimulateTemplateRequestDescriptor DataStream(Elastic.Clients.Elasticsearch.Serverless.IndexManagement.DataStreamVisibilityDescriptor descriptor)
	{
		DataStreamValue = null;
		DataStreamDescriptorAction = null;
		DataStreamDescriptor = descriptor;
	...
	public SimulateTemplateRequestDescriptor DataStream(Action<Elastic.Clients.Elasticsearch.Serverless.IndexManagement.DataStreamVisibilityDescriptor> configure)
	{
		DataStreamValue = null;
		DataStreamDescriptor = null;
		DataStreamDescriptorAction = configure;
	...
	/// </para>
	/// </summary>
	public SimulateTemplateRequestDescriptor IndexPatterns(Elastic.Clients.Elasticsearch.Serverless.Indices? indexPatterns)
	{
		IndexPatternsValue = indexPatterns;
		return Self;
	}
	...
	/// </para>
	/// </summary>
	public SimulateTemplateRequestDescriptor Template(Elastic.Clients.Elasticsearch.Serverless.IndexManagement.IndexTemplateMapping? template)
	{
		TemplateDescriptor = null;
		TemplateDescriptorAction = null;
		TemplateValue = template;
	...
	public SimulateTemplateRequestDescriptor Template(Elastic.Clients.Elasticsearch.Serverless.IndexManagement.IndexTemplateMappingDescriptor descriptor)
	{
		TemplateValue = null;
		TemplateDescriptorAction = null;
		TemplateDescriptor = descriptor;
	...
	public SimulateTemplateRequestDescriptor Template(Action<Elastic.Clients.Elasticsearch.Serverless.IndexManagement.IndexTemplateMappingDescriptor> configure)
	{
		TemplateValue = null;
		TemplateDescriptor = null;
		TemplateDescriptorAction = configure;
