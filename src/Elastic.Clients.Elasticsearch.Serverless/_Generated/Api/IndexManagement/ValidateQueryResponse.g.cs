...
internal sealed partial class ValidateQueryResponseConverter : System.Text.Json.Serialization.JsonConverter<ValidateQueryResponse>
{
	...
	public override ValidateQueryResponse Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<string?> propError = default;
		LocalJsonProperty<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.IndexManagement.IndicesValidationExplanation>?> propExplanations = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.ShardStatistics?> propShards = default;
		LocalJsonProperty<bool> propValid = default;
...
public sealed partial class ValidateQueryResponse : ElasticsearchResponse
{
	...
	public IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.IndexManagement.IndicesValidationExplanation>? Explanations { get; init; }
