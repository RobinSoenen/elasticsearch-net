...
public sealed partial class GetIndexTemplateRequest : PlainRequest<GetIndexTemplateRequestParameters>
{
	...
	public GetIndexTemplateRequest(Elastic.Clients.Elasticsearch.Serverless.Name? name) : base(r => r.Optional("name", name))
	{
	}
...
public sealed partial class GetIndexTemplateRequestDescriptor : RequestDescriptor<GetIndexTemplateRequestDescriptor, GetIndexTemplateRequestParameters>
{
	...
	public GetIndexTemplateRequestDescriptor(Elastic.Clients.Elasticsearch.Serverless.Name? name) : base(r => r.Optional("name", name))
	{
	}
	...
	public GetIndexTemplateRequestDescriptor MasterTimeout(Elastic.Clients.Elasticsearch.Serverless.Duration? masterTimeout) => Qs("master_timeout", masterTimeout);

	public GetIndexTemplateRequestDescriptor Name(Elastic.Clients.Elasticsearch.Serverless.Name? name)
	{
