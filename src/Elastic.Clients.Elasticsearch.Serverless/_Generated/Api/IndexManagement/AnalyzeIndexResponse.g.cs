...
internal sealed partial class AnalyzeIndexResponseConverter : System.Text.Json.Serialization.JsonConverter<AnalyzeIndexResponse>
{
	...
	public override AnalyzeIndexResponse Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.IndexManagement.AnalyzeDetail?> propDetail = default;
		LocalJsonProperty<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.IndexManagement.AnalyzeToken>?> propTokens = default;
...
{
	public Elastic.Clients.Elasticsearch.Serverless.IndexManagement.AnalyzeDetail? Detail { get; init; }
	public IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.IndexManagement.AnalyzeToken>? Tokens { get; init; }
}