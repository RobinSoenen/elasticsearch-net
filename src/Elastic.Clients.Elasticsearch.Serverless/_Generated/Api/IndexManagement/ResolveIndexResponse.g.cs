...
internal sealed partial class ResolveIndexResponseConverter : System.Text.Json.Serialization.JsonConverter<ResolveIndexResponse>
{
	...
	public override ResolveIndexResponse Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.IndexManagement.ResolveIndexAliasItem>> propAliases = default;
		LocalJsonProperty<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.IndexManagement.ResolveIndexDataStreamsItem>> propDataStreams = default;
		LocalJsonProperty<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.IndexManagement.ResolveIndexItem>> propIndices = default;
