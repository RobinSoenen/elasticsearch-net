...
internal sealed partial class UpdateRequestConverter<TDocument, TPartialDocument> : System.Text.Json.Serialization.JsonConverter<UpdateRequest<TDocument, TPartialDocument>>
{
	...
	public override UpdateRequest<TDocument, TPartialDocument> Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<bool?> propDetectNoop = default;
		LocalJsonProperty<TPartialDocument?> propDoc = default;
		LocalJsonProperty<bool?> propDocAsUpsert = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Script?> propScript = default;
		LocalJsonProperty<bool?> propScriptedUpsert = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Core.Search.SourceConfig?> propSource = default;
		LocalJsonProperty<TDocument?> propUpsert = default;
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, UpdateRequest<TDocument, TPartialDocument> value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		writer.WriteProperty(options, PropDoc, value.Doc, typeof(SourceMarker<TPartialDocument?>));
		...
		writer.WriteProperty(options, PropUpsert, value.Upsert, typeof(SourceMarker<TDocument?>));
