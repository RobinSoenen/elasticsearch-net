...
internal sealed partial class XpackUsageResponseConverter : System.Text.Json.Serialization.JsonConverter<XpackUsageResponse>
{
	...
	public override XpackUsageResponse Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Xpack.Base> propAggregateMetric = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Xpack.Analytics> propAnalytics = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Xpack.Archive> propArchive = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Xpack.Ccr> propCcr = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Xpack.Base?> propDataFrame = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Xpack.Base?> propDataScience = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Xpack.DataStreams?> propDataStreams = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Xpack.DataTiers> propDataTiers = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Xpack.Base?> propEnrich = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Xpack.Eql> propEql = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Xpack.Flattened?> propFlattened = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Xpack.FrozenIndices> propFrozenIndices = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Xpack.Base> propGraph = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Xpack.HealthStatistics?> propHealthApi = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Xpack.Ilm> propIlm = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Xpack.Base> propLogstash = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Xpack.MachineLearning> propMl = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Xpack.Monitoring> propMonitoring = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Xpack.Base> propRollup = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Xpack.RuntimeFieldTypes?> propRuntimeFields = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Xpack.SearchableSnapshots> propSearchableSnapshots = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Xpack.Security> propSecurity = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Xpack.Slm> propSlm = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Xpack.Base> propSpatial = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Xpack.Sql> propSql = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Xpack.Base> propTransform = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Xpack.Vector?> propVectors = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Xpack.Base> propVotingOnly = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Xpack.Watcher> propWatcher = default;
