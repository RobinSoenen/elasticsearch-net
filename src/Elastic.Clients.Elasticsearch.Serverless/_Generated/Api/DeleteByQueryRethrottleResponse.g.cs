...
internal sealed partial class DeleteByQueryRethrottleResponseConverter : System.Text.Json.Serialization.JsonConverter<DeleteByQueryRethrottleResponse>
{
	...
	public override DeleteByQueryRethrottleResponse Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.ErrorCause>?> propNodeFailures = default;
		LocalJsonProperty<IReadOnlyDictionary<string, Elastic.Clients.Elasticsearch.Serverless.Tasks.NodeTasks>?> propNodes = default;
		LocalJsonProperty<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.TaskFailure>?> propTaskFailures = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Tasks.TaskInfos?> propTasks = default;
