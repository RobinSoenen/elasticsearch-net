...
public sealed partial class GetStatsRequestDescriptor : RequestDescriptor<GetStatsRequestDescriptor, GetStatsRequestParameters>
{
	...
	public GetStatsRequestDescriptor MasterTimeout(Elastic.Clients.Elasticsearch.Serverless.Duration? masterTimeout) => Qs("master_timeout", masterTimeout);
	public GetStatsRequestDescriptor Timeout(Elastic.Clients.Elasticsearch.Serverless.Duration? timeout) => Qs("timeout", timeout);
