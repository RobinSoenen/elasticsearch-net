...
{
	public DeleteLifecycleRequest(Elastic.Clients.Elasticsearch.Serverless.Name policyId) : base(r => r.Required("policy_id", policyId))
	{
	}
...
public sealed partial class DeleteLifecycleRequestDescriptor : RequestDescriptor<DeleteLifecycleRequestDescriptor, DeleteLifecycleRequestParameters>
{
	...
	public DeleteLifecycleRequestDescriptor(Elastic.Clients.Elasticsearch.Serverless.Name policyId) : base(r => r.Required("policy_id", policyId))
	{
	}
	...
	public DeleteLifecycleRequestDescriptor MasterTimeout(Elastic.Clients.Elasticsearch.Serverless.Duration? masterTimeout) => Qs("master_timeout", masterTimeout);
	public DeleteLifecycleRequestDescriptor Timeout(Elastic.Clients.Elasticsearch.Serverless.Duration? timeout) => Qs("timeout", timeout);

	public DeleteLifecycleRequestDescriptor PolicyId(Elastic.Clients.Elasticsearch.Serverless.Name policyId)
	{
