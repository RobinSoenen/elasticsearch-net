...
public sealed partial class ExecuteRetentionRequestDescriptor : RequestDescriptor<ExecuteRetentionRequestDescriptor, ExecuteRetentionRequestParameters>
{
	...
	public ExecuteRetentionRequestDescriptor MasterTimeout(Elastic.Clients.Elasticsearch.Serverless.Duration? masterTimeout) => Qs("master_timeout", masterTimeout);
	public ExecuteRetentionRequestDescriptor Timeout(Elastic.Clients.Elasticsearch.Serverless.Duration? timeout) => Qs("timeout", timeout);
