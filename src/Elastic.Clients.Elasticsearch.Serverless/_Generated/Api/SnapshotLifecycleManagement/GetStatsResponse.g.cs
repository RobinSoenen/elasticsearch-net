...
internal sealed partial class GetStatsResponseConverter : System.Text.Json.Serialization.JsonConverter<GetStatsResponse>
{
	...
	public override GetStatsResponse Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<IReadOnlyCollection<string>> propPolicyStats = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Duration> propRetentionDeletionTime = default;
		LocalJsonProperty<long> propRetentionDeletionTimeMillis = default;
		LocalJsonProperty<long> propRetentionFailed = default;
		LocalJsonProperty<long> propRetentionRuns = default;
		LocalJsonProperty<long> propRetentionTimedOut = default;
		LocalJsonProperty<long> propTotalSnapshotDeletionFailures = default;
		LocalJsonProperty<long> propTotalSnapshotsDeleted = default;
		LocalJsonProperty<long> propTotalSnapshotsFailed = default;
		LocalJsonProperty<long> propTotalSnapshotsTaken = default;
