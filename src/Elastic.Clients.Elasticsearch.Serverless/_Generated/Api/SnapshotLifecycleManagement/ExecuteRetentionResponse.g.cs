...
internal sealed partial class ExecuteRetentionResponseConverter : System.Text.Json.Serialization.JsonConverter<ExecuteRetentionResponse>
{
	...
	public override ExecuteRetentionResponse Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		return new ExecuteRetentionResponse
		{
			Acknowledged = propAcknowledged.Value
		};
	}

	public override void Write(System.Text.Json.Utf8JsonWriter writer, ExecuteRetentionResponse value, System.Text.Json.JsonSerializerOptions options)
	{
...
[JsonConverter(typeof(ExecuteRetentionResponseConverter))]
