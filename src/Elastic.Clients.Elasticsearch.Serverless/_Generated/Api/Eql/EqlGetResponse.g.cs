...
internal sealed partial class EqlGetResponseConverter<TEvent> : System.Text.Json.Serialization.JsonConverter<EqlGetResponse<TEvent>>
{
	...
	public override EqlGetResponse<TEvent> Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Eql.EqlHits<TEvent>> propHits = default;
		...
		LocalJsonProperty<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.ShardFailure>?> propShardFailures = default;
