...
internal sealed partial class ExploreResponseConverter : System.Text.Json.Serialization.JsonConverter<ExploreResponse>
{
	...
	public override ExploreResponse Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.Graph.Connection>> propConnections = default;
		LocalJsonProperty<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.ShardFailure>> propFailures = default;
		LocalJsonProperty<bool> propTimedOut = default;
		LocalJsonProperty<long> propTook = default;
		LocalJsonProperty<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.Graph.Vertex>> propVertices = default;
