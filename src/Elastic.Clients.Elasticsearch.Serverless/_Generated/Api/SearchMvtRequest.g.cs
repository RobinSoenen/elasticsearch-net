...
internal sealed partial class SearchMvtRequestConverter : System.Text.Json.Serialization.JsonConverter<SearchMvtRequest>
{
	...
	public override SearchMvtRequest Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<IDictionary<string, Elastic.Clients.Elasticsearch.Serverless.Aggregations.Aggregation>?> propAggs = default;
		LocalJsonProperty<int?> propBuffer = default;
		LocalJsonProperty<bool?> propExactBounds = default;
		LocalJsonProperty<int?> propExtent = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Fields?> propFields = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Core.SearchMvt.GridAggregationType?> propGridAgg = default;
		LocalJsonProperty<int?> propGridPrecision = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Core.SearchMvt.GridType?> propGridType = default;
		...
		LocalJsonProperty<bool?> propWithLabels = default;
