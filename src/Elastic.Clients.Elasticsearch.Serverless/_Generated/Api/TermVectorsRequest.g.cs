...
internal sealed partial class TermVectorsRequestConverter<TDocument> : System.Text.Json.Serialization.JsonConverter<TermVectorsRequest<TDocument>>
{
	...
	public override TermVectorsRequest<TDocument> Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<TDocument?> propDoc = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Core.TermVectors.Filter?> propFilter = default;
		LocalJsonProperty<IDictionary<Elastic.Clients.Elasticsearch.Serverless.Field, string>?> propPerFieldAnalyzer = default;
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, TermVectorsRequest<TDocument> value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		writer.WriteProperty(options, PropDoc, value.Doc, typeof(SourceMarker<TDocument?>));
...
public sealed partial class TermVectorsRequestDescriptor<TDocument> : RequestDescriptor<TermVectorsRequestDescriptor<TDocument>, TermVectorsRequestParameters>
{
	...
	public TermVectorsRequestDescriptor(Elastic.Clients.Elasticsearch.Serverless.IndexName index, Elastic.Clients.Elasticsearch.Serverless.Id? id) : base(r => r.Required("index", index).Optional("id", id))
	{
	}
	...
	public TermVectorsRequestDescriptor<TDocument> Filter(Elastic.Clients.Elasticsearch.Serverless.Core.TermVectors.FilterDescriptor descriptor)
	{
		FilterValue = null;
		FilterDescriptorAction = null;
	...
	public TermVectorsRequestDescriptor<TDocument> Filter(Action<Elastic.Clients.Elasticsearch.Serverless.Core.TermVectors.FilterDescriptor> configure)
	{
		FilterValue = null;
		FilterDescriptor = null;
