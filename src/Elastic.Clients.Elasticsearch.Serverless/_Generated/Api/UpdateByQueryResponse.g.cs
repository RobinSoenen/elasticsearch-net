...
internal sealed partial class UpdateByQueryResponseConverter : System.Text.Json.Serialization.JsonConverter<UpdateByQueryResponse>
{
	...
	public override UpdateByQueryResponse Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		reader.ValidateToken(System.Text.Json.JsonTokenType.StartObject);
		LocalJsonProperty<long?> propBatches = default;
		LocalJsonProperty<long?> propDeleted = default;
		LocalJsonProperty<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.BulkIndexByScrollFailure>?> propFailures = default;
		LocalJsonProperty<long?> propNoops = default;
		LocalJsonProperty<float?> propRequestsPerSecond = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Retries?> propRetries = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.TaskId?> propTask = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Duration?> propThrottled = default;
		LocalJsonProperty<long?> propThrottledMillis = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Duration?> propThrottledUntil = default;
		LocalJsonProperty<long?> propThrottledUntilMillis = default;
		LocalJsonProperty<bool?> propTimedOut = default;
		LocalJsonProperty<long?> propTook = default;
		LocalJsonProperty<long?> propTotal = default;
		LocalJsonProperty<long?> propUpdated = default;
		LocalJsonProperty<long?> propVersionConflicts = default;
		...
		return new UpdateByQueryResponse
		{
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, UpdateByQueryResponse value, System.Text.Json.JsonSerializerOptions options)
	{
...
[JsonConverter(typeof(UpdateByQueryResponseConverter))]
