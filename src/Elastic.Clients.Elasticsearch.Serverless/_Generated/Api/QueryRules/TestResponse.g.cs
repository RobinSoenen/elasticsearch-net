...
internal sealed partial class TestResponseConverter : System.Text.Json.Serialization.JsonConverter<TestResponse>
{
	...
	public override TestResponse Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.QueryRules.QueryRulesetMatchedRule>> propMatchedRules = default;
		LocalJsonProperty<int> propTotalMatchedRules = default;
...
{
	public IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.QueryRules.QueryRulesetMatchedRule> MatchedRules { get; init; }
