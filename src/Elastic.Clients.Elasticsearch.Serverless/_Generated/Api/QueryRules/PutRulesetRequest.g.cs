...
internal sealed partial class PutRulesetRequestConverter : System.Text.Json.Serialization.JsonConverter<PutRulesetRequest>
{
	...
	public override PutRulesetRequest Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<ICollection<Elastic.Clients.Elasticsearch.Serverless.QueryRules.QueryRule>> propRules = default;
		while (reader.Read() && reader.TokenType is System.Text.Json.JsonTokenType.PropertyName)
		{
			if (propRules.TryRead(ref reader, options, PropRules, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.QueryRules.QueryRule>, Elastic.Clients.Elasticsearch.Serverless.QueryRules.QueryRule>)))
			{
				continue;
			}
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, PutRulesetRequest value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		writer.WriteProperty(options, PropRules, value.Rules, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.QueryRules.QueryRule>, Elastic.Clients.Elasticsearch.Serverless.QueryRules.QueryRule>));
