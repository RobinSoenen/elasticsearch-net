...
internal sealed partial class DeleteRulesetResponseConverter : System.Text.Json.Serialization.JsonConverter<DeleteRulesetResponse>
{
	...
	public override DeleteRulesetResponse Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, DeleteRulesetResponse value, System.Text.Json.JsonSerializerOptions options)
	{
...
[JsonConverter(typeof(DeleteRulesetResponseConverter))]
