...
internal sealed partial class ResetTransformResponseConverter : System.Text.Json.Serialization.JsonConverter<ResetTransformResponse>
{
	...
	public override ResetTransformResponse Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		return new ResetTransformResponse
		{
			Acknowledged = propAcknowledged.Value
		};
	}

	public override void Write(System.Text.Json.Utf8JsonWriter writer, ResetTransformResponse value, System.Text.Json.JsonSerializerOptions options)
	{
...
[JsonConverter(typeof(ResetTransformResponseConverter))]
