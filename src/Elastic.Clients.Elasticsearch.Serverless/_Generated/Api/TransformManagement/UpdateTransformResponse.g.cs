...
internal sealed partial class UpdateTransformResponseConverter : System.Text.Json.Serialization.JsonConverter<UpdateTransformResponse>
{
	...
	public override UpdateTransformResponse Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.MachineLearning.TransformAuthorization?> propAuthorization = default;
		LocalJsonProperty<long> propCreateTime = default;
		LocalJsonProperty<string> propDescription = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Core.Reindex.Destination> propDest = default;
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.TransformManagement.Latest?> propLatest = default;
		LocalJsonProperty<IReadOnlyDictionary<string, object>?> propMeta = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.TransformManagement.Pivot?> propPivot = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.TransformManagement.RetentionPolicy?> propRetentionPolicy = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.TransformManagement.Settings> propSettings = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Core.Reindex.Source> propSource = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.TransformManagement.Sync?> propSync = default;
