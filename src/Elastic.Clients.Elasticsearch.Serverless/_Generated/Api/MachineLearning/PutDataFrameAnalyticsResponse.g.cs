...
internal sealed partial class PutDataFrameAnalyticsResponseConverter : System.Text.Json.Serialization.JsonConverter<PutDataFrameAnalyticsResponse>
{
	...
	public override PutDataFrameAnalyticsResponse Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<bool> propAllowLazyStart = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.MachineLearning.DataframeAnalysis> propAnalysis = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.MachineLearning.DataframeAnalysisAnalyzedFields?> propAnalyzedFields = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.MachineLearning.DataframeAnalyticsAuthorization?> propAuthorization = default;
		LocalJsonProperty<long> propCreateTime = default;
		LocalJsonProperty<string?> propDescription = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.MachineLearning.DataframeAnalyticsDestination> propDest = default;
		LocalJsonProperty<string> propId = default;
		LocalJsonProperty<int> propMaxNumThreads = default;
		LocalJsonProperty<IReadOnlyDictionary<string, object>?> propMeta = default;
		LocalJsonProperty<string> propModelMemoryLimit = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.MachineLearning.DataframeAnalyticsSource> propSource = default;
