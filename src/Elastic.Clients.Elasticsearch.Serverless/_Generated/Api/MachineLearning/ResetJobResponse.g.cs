...
internal sealed partial class ResetJobResponseConverter : System.Text.Json.Serialization.JsonConverter<ResetJobResponse>
{
	...
	public override ResetJobResponse Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
...
[JsonConverter(typeof(ResetJobResponseConverter))]
public sealed partial class ResetJobResponse : ElasticsearchResponse
{
	/// <summary>
	/// <para>
