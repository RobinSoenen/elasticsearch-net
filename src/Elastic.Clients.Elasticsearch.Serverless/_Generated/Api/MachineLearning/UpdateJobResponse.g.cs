...
internal sealed partial class UpdateJobResponseConverter : System.Text.Json.Serialization.JsonConverter<UpdateJobResponse>
{
	...
	public override UpdateJobResponse Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<bool> propAllowLazyOpen = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.MachineLearning.AnalysisConfigRead> propAnalysisConfig = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.MachineLearning.AnalysisLimits> propAnalysisLimits = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Duration?> propBackgroundPersistInterval = default;
		LocalJsonProperty<long> propCreateTime = default;
		LocalJsonProperty<IReadOnlyDictionary<string, string>?> propCustomSettings = default;
		LocalJsonProperty<long> propDailyModelSnapshotRetentionAfterDays = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.MachineLearning.DataDescription> propDataDescription = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.MachineLearning.Datafeed?> propDatafeedConfig = default;
		LocalJsonProperty<string?> propDescription = default;
		LocalJsonProperty<long?> propFinishedTime = default;
		LocalJsonProperty<IReadOnlyCollection<string>?> propGroups = default;
		LocalJsonProperty<string> propJobId = default;
		LocalJsonProperty<string> propJobType = default;
		LocalJsonProperty<string> propJobVersion = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.MachineLearning.ModelPlotConfig?> propModelPlotConfig = default;
		LocalJsonProperty<string?> propModelSnapshotId = default;
		LocalJsonProperty<long> propModelSnapshotRetentionDays = default;
		LocalJsonProperty<long?> propRenormalizationWindowDays = default;
		LocalJsonProperty<string> propResultsIndexName = default;
		LocalJsonProperty<long?> propResultsRetentionDays = default;
...
public sealed partial class UpdateJobResponse : ElasticsearchResponse
{
	...
	public Elastic.Clients.Elasticsearch.Serverless.MachineLearning.AnalysisConfigRead AnalysisConfig { get; init; }
