...
internal sealed partial class AuthenticateResponseConverter : System.Text.Json.Serialization.JsonConverter<AuthenticateResponse>
{
	...
	public override AuthenticateResponse Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Security.AuthenticateApiKey?> propApiKey = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Security.RealmInfo> propAuthenticationRealm = default;
		LocalJsonProperty<string> propAuthenticationType = default;
		LocalJsonProperty<string?> propEmail = default;
		LocalJsonProperty<bool> propEnabled = default;
		LocalJsonProperty<string?> propFullName = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Security.RealmInfo> propLookupRealm = default;
		LocalJsonProperty<IReadOnlyDictionary<string, object>> propMetadata = default;
		LocalJsonProperty<IReadOnlyCollection<string>> propRoles = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Security.AuthenticateToken?> propToken = default;
		LocalJsonProperty<string> propUsername = default;
