...
internal sealed partial class InvalidateApiKeyResponseConverter : System.Text.Json.Serialization.JsonConverter<InvalidateApiKeyResponse>
{
	...
	public override InvalidateApiKeyResponse Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<int> propErrorCount = default;
		LocalJsonProperty<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.ErrorCause>?> propErrorDetails = default;
		LocalJsonProperty<IReadOnlyCollection<string>> propInvalidatedApiKeys = default;
		LocalJsonProperty<IReadOnlyCollection<string>> propPreviouslyInvalidatedApiKeys = default;
...
public sealed partial class InvalidateApiKeyResponse : ElasticsearchResponse
{
	...
	public IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.ErrorCause>? ErrorDetails { get; init; }
