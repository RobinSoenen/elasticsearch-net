...
internal sealed partial class SuggestUserProfilesResponseConverter : System.Text.Json.Serialization.JsonConverter<SuggestUserProfilesResponse>
{
	...
	public override SuggestUserProfilesResponse Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.Security.UserProfile>> propProfiles = default;
		LocalJsonProperty<long> propTook = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Security.TotalUserProfiles> propTotal = default;
...
{
	public IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.Security.UserProfile> Profiles { get; init; }
	public long Took { get; init; }
	public Elastic.Clients.Elasticsearch.Serverless.Security.TotalUserProfiles Total { get; init; }
}