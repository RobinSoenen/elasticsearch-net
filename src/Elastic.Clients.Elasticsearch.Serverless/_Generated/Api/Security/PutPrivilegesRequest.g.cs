...
public sealed partial class PutPrivilegesRequest : PlainRequest<PutPrivilegesRequestParameters>, ISelfTwoWaySerializable
{
	...
	{
		Privileges = settings.RequestResponseSerializer.Deserialize<Dictionary<string, Dictionary<string, Elastic.Clients.Elasticsearch.Serverless.Security.PrivilegeActions>>>(ref reader);
	}
}
