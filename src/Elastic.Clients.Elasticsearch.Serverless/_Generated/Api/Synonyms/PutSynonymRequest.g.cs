...
internal sealed partial class PutSynonymRequestConverter : System.Text.Json.Serialization.JsonConverter<PutSynonymRequest>
{
	...
	public override PutSynonymRequest Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<ICollection<Elastic.Clients.Elasticsearch.Serverless.Synonyms.SynonymRule>> propSynonymsSet = default;
		while (reader.Read() && reader.TokenType is System.Text.Json.JsonTokenType.PropertyName)
		{
			if (propSynonymsSet.TryRead(ref reader, options, PropSynonymsSet, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.Synonyms.SynonymRule>, Elastic.Clients.Elasticsearch.Serverless.Synonyms.SynonymRule>)))
			{
				continue;
			}
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, PutSynonymRequest value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		writer.WriteProperty(options, PropSynonymsSet, value.SynonymsSet, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.Synonyms.SynonymRule>, Elastic.Clients.Elasticsearch.Serverless.Synonyms.SynonymRule>));
