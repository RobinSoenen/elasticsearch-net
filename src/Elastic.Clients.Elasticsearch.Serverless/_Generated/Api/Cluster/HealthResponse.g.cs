...
internal sealed partial class HealthResponseConverter : System.Text.Json.Serialization.JsonConverter<HealthResponse>
{
	...
	public override HealthResponse Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<int> propActivePrimaryShards = default;
		LocalJsonProperty<int> propActiveShards = default;
		LocalJsonProperty<double> propActiveShardsPercentAsNumber = default;
		LocalJsonProperty<string> propClusterName = default;
		LocalJsonProperty<int> propDelayedUnassignedShards = default;
		LocalJsonProperty<IReadOnlyDictionary<Elastic.Clients.Elasticsearch.Serverless.IndexName, Elastic.Clients.Elasticsearch.Serverless.Cluster.IndexHealthStats>?> propIndices = default;
		LocalJsonProperty<int> propInitializingShards = default;
		LocalJsonProperty<int> propNumberOfDataNodes = default;
		LocalJsonProperty<int> propNumberOfInFlightFetch = default;
		LocalJsonProperty<int> propNumberOfNodes = default;
		LocalJsonProperty<int> propNumberOfPendingTasks = default;
		LocalJsonProperty<int> propRelocatingShards = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.HealthStatus> propStatus = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Duration?> propTaskMaxWaitingInQueue = default;
		LocalJsonProperty<long> propTaskMaxWaitingInQueueMillis = default;
		LocalJsonProperty<bool> propTimedOut = default;
		LocalJsonProperty<int> propUnassignedPrimaryShards = default;
		LocalJsonProperty<int> propUnassignedShards = default;
