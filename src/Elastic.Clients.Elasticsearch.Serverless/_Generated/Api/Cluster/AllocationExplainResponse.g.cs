...
internal sealed partial class AllocationExplainResponseConverter : System.Text.Json.Serialization.JsonConverter<AllocationExplainResponse>
{
	...
	public override AllocationExplainResponse Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<string?> propAllocateExplanation = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Duration?> propAllocationDelay = default;
		LocalJsonProperty<long?> propAllocationDelayInMillis = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Cluster.Decision?> propCanAllocate = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Cluster.Decision?> propCanMoveToOtherNode = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Cluster.Decision?> propCanRebalanceCluster = default;
		LocalJsonProperty<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.Cluster.AllocationDecision>?> propCanRebalanceClusterDecisions = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Cluster.Decision?> propCanRebalanceToOtherNode = default;
		LocalJsonProperty<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.Cluster.AllocationDecision>?> propCanRemainDecisions = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Cluster.Decision?> propCanRemainOnCurrentNode = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Cluster.ClusterInfo?> propClusterInfo = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Duration?> propConfiguredDelay = default;
		LocalJsonProperty<long?> propConfiguredDelayInMillis = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Cluster.CurrentNode?> propCurrentNode = default;
		LocalJsonProperty<string> propCurrentState = default;
		LocalJsonProperty<string> propIndex = default;
		LocalJsonProperty<string?> propMoveExplanation = default;
		LocalJsonProperty<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.Cluster.NodeAllocationExplanation>?> propNodeAllocationDecisions = default;
		LocalJsonProperty<string?> propNote = default;
		LocalJsonProperty<bool> propPrimary = default;
		LocalJsonProperty<string?> propRebalanceExplanation = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Duration?> propRemainingDelay = default;
		LocalJsonProperty<long?> propRemainingDelayInMillis = default;
		LocalJsonProperty<int> propShard = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Cluster.UnassignedInformation?> propUnassignedInfo = default;
