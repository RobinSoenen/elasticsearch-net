...
internal sealed partial class ScriptConverter : System.Text.Json.Serialization.JsonConverter<Script>
{
	...
	public override Script Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.ScriptLanguage?> propLang = default;
		LocalJsonProperty<IDictionary<string, string>?> propOptions = default;
		LocalJsonProperty<IDictionary<string, object>?> propParams = default;
		LocalJsonProperty<string?> propSource = default;
