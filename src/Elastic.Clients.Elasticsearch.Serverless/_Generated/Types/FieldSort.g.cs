...
internal sealed partial class FieldSortConverter : System.Text.Json.Serialization.JsonConverter<FieldSort>
{
	...
	public override FieldSort Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		{
			var value = reader.ReadValue<Elastic.Clients.Elasticsearch.Serverless.SortOrder?>(options);
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.FieldSortNumericType?> propNumericType = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.SortOrder?> propOrder = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Mapping.FieldType?> propUnmappedType = default;
