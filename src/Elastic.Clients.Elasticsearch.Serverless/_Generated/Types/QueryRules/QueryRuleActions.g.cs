...
public sealed partial class QueryRuleActions
{
	...
	public ICollection<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.PinnedDoc>? Docs { get; set; }
...
public sealed partial class QueryRuleActionsDescriptor : SerializableDescriptor<QueryRuleActionsDescriptor>
{
	...
	private ICollection<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.PinnedDoc>? DocsValue { get; set; }
	private Elastic.Clients.Elasticsearch.Serverless.QueryDsl.PinnedDocDescriptor DocsDescriptor { get; set; }
	private Action<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.PinnedDocDescriptor> DocsDescriptorAction { get; set; }
	private Action<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.PinnedDocDescriptor>[] DocsDescriptorActions { get; set; }
	...
	/// </list>
	/// </summary>
	public QueryRuleActionsDescriptor Docs(ICollection<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.PinnedDoc>? docs)
	{
		DocsDescriptor = null;
	...
	public QueryRuleActionsDescriptor Docs(Elastic.Clients.Elasticsearch.Serverless.QueryDsl.PinnedDocDescriptor descriptor)
	{
		DocsValue = null;
		DocsDescriptorAction = null;
		DocsDescriptorActions = null;
	...
	public QueryRuleActionsDescriptor Docs(Action<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.PinnedDocDescriptor> configure)
	{
		DocsValue = null;
		DocsDescriptor = null;
		DocsDescriptorActions = null;
	...
	public QueryRuleActionsDescriptor Docs(params Action<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.PinnedDocDescriptor>[] configure)
	{
		DocsValue = null;
		DocsDescriptor = null;
		DocsDescriptorAction = null;
	...
	/// </para>
	/// </summary>
	public QueryRuleActionsDescriptor Ids(ICollection<Elastic.Clients.Elasticsearch.Serverless.Id>? ids)
	{
		IdsValue = ids;
		return Self;
	}
	...
	protected override void Serialize(Utf8JsonWriter writer, JsonSerializerOptions options, IElasticsearchClientSettings settings)
	{
		...
		else if (DocsDescriptorAction is not null)
		{
			writer.WritePropertyName("docs");
			writer.WriteStartArray();
			JsonSerializer.Serialize(writer, new Elastic.Clients.Elasticsearch.Serverless.QueryDsl.PinnedDocDescriptor(DocsDescriptorAction), options);
			writer.WriteEndArray();
		}
		else if (DocsDescriptorActions is not null)
		{
			...
			{
				JsonSerializer.Serialize(writer, new Elastic.Clients.Elasticsearch.Serverless.QueryDsl.PinnedDocDescriptor(action), options);
			}
