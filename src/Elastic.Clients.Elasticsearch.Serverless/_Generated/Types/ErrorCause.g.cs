...
internal sealed partial class ErrorCauseConverter : System.Text.Json.Serialization.JsonConverter<ErrorCause>
{
	...
	public override ErrorCause Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.ErrorCause?> propCausedBy = default;
		LocalJsonProperty<string?> propReason = default;
		LocalJsonProperty<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.ErrorCause>?> propRootCause = default;
		LocalJsonProperty<string?> propStackTrace = default;
		LocalJsonProperty<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.ErrorCause>?> propSuppressed = default;
