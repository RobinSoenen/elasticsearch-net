...
internal sealed partial class HitsEventConverter<TEvent> : System.Text.Json.Serialization.JsonConverter<HitsEvent<TEvent>>
{
	...
	public override HitsEvent<TEvent> Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<IReadOnlyDictionary<Elastic.Clients.Elasticsearch.Serverless.Field, IReadOnlyCollection<object>>?> propFields = default;
		LocalJsonProperty<string> propId = default;
		LocalJsonProperty<string> propIndex = default;
		LocalJsonProperty<bool?> propMissing = default;
		LocalJsonProperty<TEvent> propSource = default;
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, HitsEvent<TEvent> value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		writer.WriteProperty(options, PropSource, value.Source, typeof(SourceMarker<TEvent>));
...
{
	public IReadOnlyDictionary<Elastic.Clients.Elasticsearch.Serverless.Field, IReadOnlyCollection<object>>? Fields { get; init; }
