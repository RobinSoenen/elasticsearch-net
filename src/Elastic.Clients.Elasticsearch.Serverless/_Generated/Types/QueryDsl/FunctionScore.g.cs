...
public sealed partial class FunctionScore
{
	...
	public static FunctionScore Exp(Elastic.Clients.Elasticsearch.Serverless.QueryDsl.IDecayFunction decayFunction) => new FunctionScore("exp", decayFunction);
	...
	public static FunctionScore Gauss(Elastic.Clients.Elasticsearch.Serverless.QueryDsl.IDecayFunction decayFunction) => new FunctionScore("gauss", decayFunction);
	...
	public static FunctionScore Linear(Elastic.Clients.Elasticsearch.Serverless.QueryDsl.IDecayFunction decayFunction) => new FunctionScore("linear", decayFunction);
...
internal sealed partial class FunctionScoreConverter : System.Text.Json.Serialization.JsonConverter<FunctionScore>
{
	...
	public override FunctionScore Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Query?> propFilter = default;
		LocalJsonProperty<double?> propWeight = default;
		...
		while (reader.Read() && reader.TokenType is System.Text.Json.JsonTokenType.PropertyName)
		{
			...
			if (reader.ValueTextEquals(VariantExp))
			{
				...
				reader.Read();
				variant = reader.ReadValue<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.IDecayFunction>(options);
				continue;
			}
			...
			if (reader.ValueTextEquals(VariantFieldValueFactor))
			{
				...
				reader.Read();
				variant = reader.ReadValue<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.FieldValueFactorScoreFunction?>(options);
				continue;
			}
			...
			if (reader.ValueTextEquals(VariantRandomScore))
			{
				...
				reader.Read();
				variant = reader.ReadValue<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.RandomScoreFunction?>(options);
				continue;
			}
			...
			if (reader.ValueTextEquals(VariantScriptScore))
			{
				...
				reader.Read();
				variant = reader.ReadValue<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.ScriptScoreFunction?>(options);
				continue;
			}
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, FunctionScore value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		switch (value.VariantType)
		{
			case "":
				break;
			case "exp":
				writer.WriteProperty(options, value.VariantType, (Elastic.Clients.Elasticsearch.Serverless.QueryDsl.IDecayFunction)value.Variant);
				break;
			case "field_value_factor":
				writer.WriteProperty(options, value.VariantType, (Elastic.Clients.Elasticsearch.Serverless.QueryDsl.FieldValueFactorScoreFunction?)value.Variant);
				break;
			case "gauss":
				writer.WriteProperty(options, value.VariantType, (Elastic.Clients.Elasticsearch.Serverless.QueryDsl.IDecayFunction)value.Variant);
				break;
			case "linear":
				...
				break;
			case "random_score":
				writer.WriteProperty(options, value.VariantType, (Elastic.Clients.Elasticsearch.Serverless.QueryDsl.RandomScoreFunction?)value.Variant);
				break;
			case "script_score":
				writer.WriteProperty(options, value.VariantType, (Elastic.Clients.Elasticsearch.Serverless.QueryDsl.ScriptScoreFunction?)value.Variant);
				break;
			default:
...
public sealed partial class FunctionScoreDescriptor<TDocument> : SerializableDescriptor<FunctionScoreDescriptor<TDocument>>
{
	...
	public FunctionScoreDescriptor<TDocument> Exp(Elastic.Clients.Elasticsearch.Serverless.QueryDsl.IDecayFunction decayFunction) => Set(decayFunction, "exp");
	...
	public FunctionScoreDescriptor<TDocument> Gauss(Elastic.Clients.Elasticsearch.Serverless.QueryDsl.IDecayFunction decayFunction) => Set(decayFunction, "gauss");
	...
	public FunctionScoreDescriptor<TDocument> Linear(Elastic.Clients.Elasticsearch.Serverless.QueryDsl.IDecayFunction decayFunction) => Set(decayFunction, "linear");
...
public sealed partial class FunctionScoreDescriptor : SerializableDescriptor<FunctionScoreDescriptor>
{
	...
	public FunctionScoreDescriptor Exp(Elastic.Clients.Elasticsearch.Serverless.QueryDsl.IDecayFunction decayFunction) => Set(decayFunction, "exp");
	...
	public FunctionScoreDescriptor Gauss(Elastic.Clients.Elasticsearch.Serverless.QueryDsl.IDecayFunction decayFunction) => Set(decayFunction, "gauss");
	...
	public FunctionScoreDescriptor Linear(Elastic.Clients.Elasticsearch.Serverless.QueryDsl.IDecayFunction decayFunction) => Set(decayFunction, "linear");
