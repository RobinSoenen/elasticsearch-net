...
internal sealed partial class QueryStringQueryConverter : System.Text.Json.Serialization.JsonConverter<QueryStringQuery>
{
	...
	public override QueryStringQuery Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<bool?> propAllowLeadingWildcard = default;
		LocalJsonProperty<string?> propAnalyzer = default;
		LocalJsonProperty<bool?> propAnalyzeWildcard = default;
		LocalJsonProperty<bool?> propAutoGenerateSynonymsPhraseQuery = default;
		LocalJsonProperty<float?> propBoost = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Field?> propDefaultField = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Operator?> propDefaultOperator = default;
		LocalJsonProperty<bool?> propEnablePositionIncrements = default;
		LocalJsonProperty<bool?> propEscape = default;
		...
		LocalJsonProperty<int?> propFuzzyMaxExpansions = default;
		LocalJsonProperty<int?> propFuzzyPrefixLength = default;
		...
		LocalJsonProperty<int?> propMaxDeterminizedStates = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.MinimumShouldMatch?> propMinimumShouldMatch = default;
		LocalJsonProperty<double?> propPhraseSlop = default;
		LocalJsonProperty<string> propQuery = default;
		LocalJsonProperty<string?> propQueryName = default;
		LocalJsonProperty<string?> propQuoteAnalyzer = default;
		LocalJsonProperty<string?> propQuoteFieldSuffix = default;
		LocalJsonProperty<string?> propRewrite = default;
		LocalJsonProperty<double?> propTieBreaker = default;
		LocalJsonProperty<string?> propTimeZone = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.TextQueryType?> propType = default;
