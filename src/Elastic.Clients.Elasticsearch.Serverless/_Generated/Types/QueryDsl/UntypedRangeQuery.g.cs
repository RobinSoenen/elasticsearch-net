...
internal sealed partial class UntypedRangeQueryConverter : System.Text.Json.Serialization.JsonConverter<UntypedRangeQuery>
{
	...
	public override UntypedRangeQuery Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<object?> propGt = default;
		LocalJsonProperty<object?> propGte = default;
		LocalJsonProperty<object?> propLt = default;
		LocalJsonProperty<object?> propLte = default;
		LocalJsonProperty<string?> propQueryName = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.RangeRelation?> propRelation = default;
...
{
	public UntypedRangeQuery(Elastic.Clients.Elasticsearch.Serverless.Field field)
	{
		if (field is null)
...
public sealed partial class UntypedRangeQueryDescriptor<TDocument> : SerializableDescriptor<UntypedRangeQueryDescriptor<TDocument>>
{
	...
	public UntypedRangeQueryDescriptor<TDocument> Field(Elastic.Clients.Elasticsearch.Serverless.Field field)
	{
		FieldValue = field;
		return Self;
	}
	...
	/// </para>
	/// </summary>
	public UntypedRangeQueryDescriptor<TDocument> Relation(Elastic.Clients.Elasticsearch.Serverless.QueryDsl.RangeRelation? relation)
	{
...
public sealed partial class UntypedRangeQueryDescriptor : SerializableDescriptor<UntypedRangeQueryDescriptor>
{
	...
	public UntypedRangeQueryDescriptor Field(Elastic.Clients.Elasticsearch.Serverless.Field field)
	{
		FieldValue = field;
		return Self;
	}
	...
	/// </para>
	/// </summary>
	public UntypedRangeQueryDescriptor Relation(Elastic.Clients.Elasticsearch.Serverless.QueryDsl.RangeRelation? relation)
	{
		RelationValue = relation;
		return Self;
	}
