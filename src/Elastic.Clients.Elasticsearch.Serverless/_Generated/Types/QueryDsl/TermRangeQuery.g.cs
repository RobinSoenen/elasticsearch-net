...
internal sealed partial class TermRangeQueryConverter : System.Text.Json.Serialization.JsonConverter<TermRangeQuery>
{
	...
	public override TermRangeQuery Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<string?> propGt = default;
		LocalJsonProperty<string?> propGte = default;
		LocalJsonProperty<string?> propLt = default;
		LocalJsonProperty<string?> propLte = default;
...
{
	public TermRangeQuery(Elastic.Clients.Elasticsearch.Serverless.Field field)
	{
		if (field is null)
...
public sealed partial class TermRangeQueryDescriptor<TDocument> : SerializableDescriptor<TermRangeQueryDescriptor<TDocument>>
{
	...
	public TermRangeQueryDescriptor<TDocument> Field(Elastic.Clients.Elasticsearch.Serverless.Field field)
	{
		FieldValue = field;
		return Self;
	}
	...
	/// </para>
	/// </summary>
	public TermRangeQueryDescriptor<TDocument> Relation(Elastic.Clients.Elasticsearch.Serverless.QueryDsl.RangeRelation? relation)
	{
...
public sealed partial class TermRangeQueryDescriptor : SerializableDescriptor<TermRangeQueryDescriptor>
{
	...
	public TermRangeQueryDescriptor Field(Elastic.Clients.Elasticsearch.Serverless.Field field)
	{
		FieldValue = field;
		return Self;
	}
	...
	/// </para>
	/// </summary>
	public TermRangeQueryDescriptor Relation(Elastic.Clients.Elasticsearch.Serverless.QueryDsl.RangeRelation? relation)
	{
		RelationValue = relation;
		return Self;
	}
