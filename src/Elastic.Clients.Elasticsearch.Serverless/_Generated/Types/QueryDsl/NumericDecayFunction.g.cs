...
internal sealed partial class NumericDecayFunctionConverter : System.Text.Json.Serialization.JsonConverter<NumericDecayFunction>
{
	...
	private static readonly System.Text.Json.JsonEncodedText PropPlacement = System.Text.Json.JsonEncodedText.Encode("placement");
	...
	public override NumericDecayFunction Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.DecayPlacement<double, double>> propPlacement = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.MultiValueMode?> propMultiValueMode = default;
...
public sealed partial class NumericDecayFunctionDescriptor<TDocument> : SerializableDescriptor<NumericDecayFunctionDescriptor<TDocument>>
{
	...
	private Elastic.Clients.Elasticsearch.Serverless.QueryDsl.DecayPlacement<double, double> PlacementValue { get; set; }

	public NumericDecayFunctionDescriptor<TDocument> Field(Elastic.Clients.Elasticsearch.Serverless.Field field)
	{
		FieldValue = field;
		return Self;
	}
	...
	public NumericDecayFunctionDescriptor<TDocument> Placement(Elastic.Clients.Elasticsearch.Serverless.QueryDsl.DecayPlacement<double, double> placement)
	{
...
public sealed partial class NumericDecayFunctionDescriptor : SerializableDescriptor<NumericDecayFunctionDescriptor>
{
	...
	public NumericDecayFunctionDescriptor Field(Elastic.Clients.Elasticsearch.Serverless.Field field)
	{
		FieldValue = field;
		return Self;
	}
	...
	public NumericDecayFunctionDescriptor Placement(Elastic.Clients.Elasticsearch.Serverless.QueryDsl.DecayPlacement<double, double> placement)
	{
		PlacementValue = placement;
		return Self;
	}
