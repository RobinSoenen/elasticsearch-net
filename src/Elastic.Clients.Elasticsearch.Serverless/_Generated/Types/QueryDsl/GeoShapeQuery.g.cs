...
internal sealed partial class GeoShapeQueryConverter : System.Text.Json.Serialization.JsonConverter<GeoShapeQuery>
{
	...
	public override GeoShapeQuery Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.GeoShapeFieldQuery> propShape = default;
		...
		while (reader.Read() && reader.TokenType is System.Text.Json.JsonTokenType.PropertyName)
		{
			...
			reader.ReadProperty(options, out propField.Value, out propShape.Value);
		}
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, GeoShapeQuery value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		writer.WriteProperty(options, value.Field, value.Shape);
...
public sealed partial class GeoShapeQuery
{
	...
	public Elastic.Clients.Elasticsearch.Serverless.QueryDsl.GeoShapeFieldQuery Shape { get; set; }

	public static implicit operator Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Query(GeoShapeQuery geoShapeQuery) => Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Query.GeoShape(geoShapeQuery);
}
...
public sealed partial class GeoShapeQueryDescriptor<TDocument> : SerializableDescriptor<GeoShapeQueryDescriptor<TDocument>>
{
	...
	private Elastic.Clients.Elasticsearch.Serverless.QueryDsl.GeoShapeFieldQuery ShapeValue { get; set; }
	private Elastic.Clients.Elasticsearch.Serverless.QueryDsl.GeoShapeFieldQueryDescriptor<TDocument> ShapeDescriptor { get; set; }
	...
	public GeoShapeQueryDescriptor<TDocument> Field(Elastic.Clients.Elasticsearch.Serverless.Field field)
	{
		FieldValue = field;
		return Self;
	}
	...
	public GeoShapeQueryDescriptor<TDocument> Shape(Elastic.Clients.Elasticsearch.Serverless.QueryDsl.GeoShapeFieldQuery shape)
	{
	...
	public GeoShapeQueryDescriptor<TDocument> Shape(Elastic.Clients.Elasticsearch.Serverless.QueryDsl.GeoShapeFieldQueryDescriptor<TDocument> descriptor)
	{
		ShapeValue = null;
		ShapeDescriptorAction = null;
	...
	public GeoShapeQueryDescriptor<TDocument> Shape(Action<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.GeoShapeFieldQueryDescriptor<TDocument>> configure)
	{
		ShapeValue = null;
		ShapeDescriptor = null;
...
public sealed partial class GeoShapeQueryDescriptor : SerializableDescriptor<GeoShapeQueryDescriptor>
{
	...
	private string? QueryNameValue { get; set; }
	private Elastic.Clients.Elasticsearch.Serverless.QueryDsl.GeoShapeFieldQuery ShapeValue { get; set; }
	private Elastic.Clients.Elasticsearch.Serverless.QueryDsl.GeoShapeFieldQueryDescriptor ShapeDescriptor { get; set; }
	...
	public GeoShapeQueryDescriptor Field(Elastic.Clients.Elasticsearch.Serverless.Field field)
	{
		FieldValue = field;
		return Self;
	}
	...
	public GeoShapeQueryDescriptor Shape(Elastic.Clients.Elasticsearch.Serverless.QueryDsl.GeoShapeFieldQuery shape)
	{
		ShapeDescriptor = null;
		ShapeDescriptorAction = null;
		ShapeValue = shape;
	...
	public GeoShapeQueryDescriptor Shape(Elastic.Clients.Elasticsearch.Serverless.QueryDsl.GeoShapeFieldQueryDescriptor descriptor)
	{
		ShapeValue = null;
		ShapeDescriptorAction = null;
		ShapeDescriptor = descriptor;
	...
	public GeoShapeQueryDescriptor Shape(Action<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.GeoShapeFieldQueryDescriptor> configure)
	{
		ShapeValue = null;
		ShapeDescriptor = null;
		ShapeDescriptorAction = configure;
