...
internal sealed partial class FuzzyQueryConverter : System.Text.Json.Serialization.JsonConverter<FuzzyQuery>
{
	...
	public override FuzzyQuery Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<bool?> propTranspositions = default;
		LocalJsonProperty<object> propValue = default;
...
{
	public FuzzyQuery(Elastic.Clients.Elasticsearch.Serverless.Field field)
	{
		if (field is null)
	...
	public static implicit operator Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Query(FuzzyQuery fuzzyQuery) => Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Query.Fuzzy(fuzzyQuery);
}
