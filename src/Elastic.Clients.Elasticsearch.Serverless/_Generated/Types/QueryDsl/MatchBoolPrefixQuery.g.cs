...
{
	public MatchBoolPrefixQuery(Elastic.Clients.Elasticsearch.Serverless.Field field)
	{
		if (field is null)
	...
	public static implicit operator Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Query(MatchBoolPrefixQuery matchBoolPrefixQuery) => Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Query.MatchBoolPrefix(matchBoolPrefixQuery);
}
