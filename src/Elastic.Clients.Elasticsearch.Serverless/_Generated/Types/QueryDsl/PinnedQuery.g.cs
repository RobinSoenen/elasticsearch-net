...
internal sealed partial class PinnedQueryConverter : System.Text.Json.Serialization.JsonConverter<PinnedQuery>
{
	...
	public override PinnedQuery Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Query> propOrganic = default;
		...
		while (reader.Read() && reader.TokenType is System.Text.Json.JsonTokenType.PropertyName)
		{
			...
			if (reader.ValueTextEquals(VariantDocs))
			{
				...
				reader.Read();
				variant = reader.ReadValue<ICollection<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.PinnedDoc>?>(options);
				continue;
			}
			...
			if (reader.ValueTextEquals(VariantIds))
			{
				...
				reader.Read();
				variant = reader.ReadValue<ICollection<Elastic.Clients.Elasticsearch.Serverless.Id>?>(options);
				continue;
			}
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, PinnedQuery value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		switch (value.VariantType)
		{
			case "":
				break;
			case "docs":
				writer.WriteProperty(options, value.VariantType, (ICollection<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.PinnedDoc>?)value.Variant);
				break;
			case "ids":
				writer.WriteProperty(options, value.VariantType, (ICollection<Elastic.Clients.Elasticsearch.Serverless.Id>?)value.Variant);
				break;
			default:
