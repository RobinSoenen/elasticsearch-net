...
{
	private static readonly System.Text.Json.JsonEncodedText PropBoundingBox = System.Text.Json.JsonEncodedText.Encode("bounding_box");
	...
	public override GeoBoundingBoxQuery Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.GeoBounds> propBoundingBox = default;
...
public sealed partial class GeoBoundingBoxQueryDescriptor : SerializableDescriptor<GeoBoundingBoxQueryDescriptor>
{
	...
	public GeoBoundingBoxQueryDescriptor BoundingBox(Elastic.Clients.Elasticsearch.Serverless.GeoBounds boundingBox)
	{
		BoundingBoxValue = boundingBox;
		return Self;
	}

	public GeoBoundingBoxQueryDescriptor Field(Elastic.Clients.Elasticsearch.Serverless.Field field)
	{
		FieldValue = field;
		return Self;
	}
