...
internal sealed partial class TermQueryConverter : System.Text.Json.Serialization.JsonConverter<TermQuery>
{
	...
	public override TermQuery Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<bool?> propCaseInsensitive = default;
		LocalJsonProperty<string?> propQueryName = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.FieldValue> propValue = default;
		while (reader.Read() && reader.TokenType is System.Text.Json.JsonTokenType.PropertyName)
		{
			...
			try
			{
				...
				var result = reader.ReadValue<Elastic.Clients.Elasticsearch.Serverless.FieldValue>(options);
				return new TermQuery { Field = propField.Value, Value = result };
			}
...
public sealed partial class TermQuery
{
	...
	public static implicit operator Elastic.Clients.Elasticsearch.Serverless.Security.ApiKeyQuery(TermQuery termQuery) => Elastic.Clients.Elasticsearch.Serverless.Security.ApiKeyQuery.Term(termQuery);
	public static implicit operator Elastic.Clients.Elasticsearch.Serverless.Security.RoleQuery(TermQuery termQuery) => Elastic.Clients.Elasticsearch.Serverless.Security.RoleQuery.Term(termQuery);
	public static implicit operator Elastic.Clients.Elasticsearch.Serverless.Security.UserQuery(TermQuery termQuery) => Elastic.Clients.Elasticsearch.Serverless.Security.UserQuery.Term(termQuery);
}
