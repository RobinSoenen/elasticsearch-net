...
internal sealed partial class DistanceFeatureQueryConverter : System.Text.Json.Serialization.JsonConverter<IDistanceFeatureQuery>
{
	...
	{
		return reader.ReadValue<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.UntypedDistanceFeatureQuery>(options);
	}
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, IDistanceFeatureQuery value, System.Text.Json.JsonSerializerOptions options)
	{
		switch (value)
		{
			case Elastic.Clients.Elasticsearch.Serverless.QueryDsl.DateDistanceFeatureQuery v:
				writer.WriteValue(options, v);
				break;
			case Elastic.Clients.Elasticsearch.Serverless.QueryDsl.GeoDistanceFeatureQuery v:
				writer.WriteValue(options, v);
				break;
			case Elastic.Clients.Elasticsearch.Serverless.QueryDsl.UntypedDistanceFeatureQuery v:
				writer.WriteValue(options, v);
				break;
			default:
