...
internal sealed partial class BoolQueryConverter : System.Text.Json.Serialization.JsonConverter<BoolQuery>
{
	...
	public override BoolQuery Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<ICollection<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Query>?> propMust = default;
		LocalJsonProperty<ICollection<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Query>?> propMustNot = default;
		LocalJsonProperty<string?> propQueryName = default;
		LocalJsonProperty<ICollection<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Query>?> propShould = default;
		while (reader.Read() && reader.TokenType is System.Text.Json.JsonTokenType.PropertyName)
		{
			...
			if (propMust.TryRead(ref reader, options, PropMust, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Query>?, Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Query>)))
			{
				continue;
			}

			if (propMustNot.TryRead(ref reader, options, PropMustNot, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Query>?, Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Query>)))
			{
				continue;
			}
			...
			if (propShould.TryRead(ref reader, options, PropShould, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Query>?, Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Query>)))
			{
				continue;
			}
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, BoolQuery value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		writer.WriteProperty(options, PropMust, value.Must, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Query>?, Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Query>));
		writer.WriteProperty(options, PropMustNot, value.MustNot, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Query>?, Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Query>));
		writer.WriteProperty(options, PropQueryName, value.QueryName);
		writer.WriteProperty(options, PropShould, value.Should, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Query>?, Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Query>));
