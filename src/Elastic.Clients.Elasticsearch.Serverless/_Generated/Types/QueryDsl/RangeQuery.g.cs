...
internal sealed partial class RangeQueryConverter : System.Text.Json.Serialization.JsonConverter<IRangeQuery>
{
	...
	{
		return reader.ReadValue<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.UntypedRangeQuery>(options);
	}
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, IRangeQuery value, System.Text.Json.JsonSerializerOptions options)
	{
		switch (value)
		{
			case Elastic.Clients.Elasticsearch.Serverless.QueryDsl.DateRangeQuery v:
				writer.WriteValue(options, v);
				break;
			case Elastic.Clients.Elasticsearch.Serverless.QueryDsl.NumberRangeQuery v:
				writer.WriteValue(options, v);
				break;
			case Elastic.Clients.Elasticsearch.Serverless.QueryDsl.TermRangeQuery v:
				writer.WriteValue(options, v);
				break;
			case Elastic.Clients.Elasticsearch.Serverless.QueryDsl.UntypedRangeQuery v:
				writer.WriteValue(options, v);
				break;
			default:
