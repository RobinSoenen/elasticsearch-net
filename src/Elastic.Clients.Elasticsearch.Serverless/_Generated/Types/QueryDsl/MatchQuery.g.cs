...
internal sealed partial class MatchQueryConverter : System.Text.Json.Serialization.JsonConverter<MatchQuery>
{
	...
	public override MatchQuery Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		reader.Read();
		propField.Value = reader.ReadValue<Elastic.Clients.Elasticsearch.Serverless.Field>(options);
		...
		LocalJsonProperty<bool?> propAutoGenerateSynonymsPhraseQuery = default;
		LocalJsonProperty<float?> propBoost = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Fuzziness?> propFuzziness = default;
		LocalJsonProperty<string?> propFuzzyRewrite = default;
		LocalJsonProperty<bool?> propFuzzyTranspositions = default;
		LocalJsonProperty<bool?> propLenient = default;
		LocalJsonProperty<int?> propMaxExpansions = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.MinimumShouldMatch?> propMinimumShouldMatch = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Operator?> propOperator = default;
		LocalJsonProperty<int?> propPrefixLength = default;
		LocalJsonProperty<object> propQuery = default;
		LocalJsonProperty<string?> propQueryName = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.ZeroTermsQuery?> propZeroTermsQuery = default;
...
{
	public MatchQuery(Elastic.Clients.Elasticsearch.Serverless.Field field)
	{
		if (field is null)
	...
	public static implicit operator Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Query(MatchQuery matchQuery) => Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Query.Match(matchQuery);
	public static implicit operator Elastic.Clients.Elasticsearch.Serverless.Security.ApiKeyQuery(MatchQuery matchQuery) => Elastic.Clients.Elasticsearch.Serverless.Security.ApiKeyQuery.Match(matchQuery);
	public static implicit operator Elastic.Clients.Elasticsearch.Serverless.Security.RoleQuery(MatchQuery matchQuery) => Elastic.Clients.Elasticsearch.Serverless.Security.RoleQuery.Match(matchQuery);
	public static implicit operator Elastic.Clients.Elasticsearch.Serverless.Security.UserQuery(MatchQuery matchQuery) => Elastic.Clients.Elasticsearch.Serverless.Security.UserQuery.Match(matchQuery);
}
...
public sealed partial class MatchQueryDescriptor<TDocument> : SerializableDescriptor<MatchQueryDescriptor<TDocument>>
{
	...
	public MatchQueryDescriptor<TDocument> Field(Elastic.Clients.Elasticsearch.Serverless.Field field)
	{
		FieldValue = field;
		return Self;
	}
...
public sealed partial class MatchQueryDescriptor : SerializableDescriptor<MatchQueryDescriptor>
{
	...
	public MatchQueryDescriptor Field(Elastic.Clients.Elasticsearch.Serverless.Field field)
	{
		FieldValue = field;
		return Self;
	}
