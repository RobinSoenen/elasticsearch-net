...
internal sealed partial class FunctionScoreQueryConverter : System.Text.Json.Serialization.JsonConverter<FunctionScoreQuery>
{
	...
	public override FunctionScoreQuery Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		{
			var value = reader.ReadValue<ICollection<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.FunctionScore>?>(options);
			return new FunctionScoreQuery { Functions = value };
		}

		reader.ValidateToken(System.Text.Json.JsonTokenType.StartObject);
		LocalJsonProperty<float?> propBoost = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.FunctionBoostMode?> propBoostMode = default;
		LocalJsonProperty<ICollection<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.FunctionScore>?> propFunctions = default;
		LocalJsonProperty<double?> propMaxBoost = default;
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.FunctionScoreMode?> propScoreMode = default;
