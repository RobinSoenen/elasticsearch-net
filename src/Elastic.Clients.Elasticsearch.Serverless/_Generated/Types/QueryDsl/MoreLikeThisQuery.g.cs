...
internal sealed partial class MoreLikeThisQueryConverter : System.Text.Json.Serialization.JsonConverter<MoreLikeThisQuery>
{
	...
	public override MoreLikeThisQuery Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<double?> propBoostTerms = default;
		LocalJsonProperty<bool?> propFailOnUnsupportedField = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Fields?> propFields = default;
		LocalJsonProperty<bool?> propInclude = default;
		LocalJsonProperty<ICollection<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Like>> propLike = default;
		LocalJsonProperty<int?> propMaxDocFreq = default;
		LocalJsonProperty<int?> propMaxQueryTerms = default;
		LocalJsonProperty<int?> propMaxWordLength = default;
		LocalJsonProperty<int?> propMinDocFreq = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.MinimumShouldMatch?> propMinimumShouldMatch = default;
		LocalJsonProperty<int?> propMinTermFreq = default;
		LocalJsonProperty<int?> propMinWordLength = default;
		LocalJsonProperty<string?> propQueryName = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Routing?> propRouting = default;
		LocalJsonProperty<ICollection<string>?> propStopWords = default;
		LocalJsonProperty<ICollection<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Like>?> propUnlike = default;
		LocalJsonProperty<long?> propVersion = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.VersionType?> propVersionType = default;
		while (reader.Read() && reader.TokenType is System.Text.Json.JsonTokenType.PropertyName)
		{
			...
			if (propLike.TryRead(ref reader, options, PropLike, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Like>, Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Like>)))
			{
				continue;
			}
			...
			if (propStopWords.TryRead(ref reader, options, PropStopWords, typeof(SingleOrManyMarker<IReadOnlyCollection<string>?, string>)))
			{
				continue;
			}

			if (propUnlike.TryRead(ref reader, options, PropUnlike, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Like>?, Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Like>)))
			{
				continue;
			}
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, MoreLikeThisQuery value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		writer.WriteProperty(options, PropFields, value.Fields, typeof(FieldsMarker));
		writer.WriteProperty(options, PropInclude, value.Include);
		writer.WriteProperty(options, PropLike, value.Like, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Like>, Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Like>));
		...
		writer.WriteProperty(options, PropStopWords, value.StopWords, typeof(SingleOrManyMarker<IReadOnlyCollection<string>?, string>));
		writer.WriteProperty(options, PropUnlike, value.Unlike, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Like>?, Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Like>));
...
public sealed partial class MoreLikeThisQuery
{
	...
	public static implicit operator Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Query(MoreLikeThisQuery moreLikeThisQuery) => Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Query.MoreLikeThis(moreLikeThisQuery);
}
