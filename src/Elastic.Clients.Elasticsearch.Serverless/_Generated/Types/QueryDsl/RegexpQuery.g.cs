...
internal sealed partial class RegexpQueryConverter : System.Text.Json.Serialization.JsonConverter<RegexpQuery>
{
	...
	public override RegexpQuery Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<string?> propFlags = default;
		...
		LocalJsonProperty<string> propValue = default;
...
{
	public RegexpQuery(Elastic.Clients.Elasticsearch.Serverless.Field field)
	{
		if (field is null)
	...
	public static implicit operator Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Query(RegexpQuery regexpQuery) => Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Query.Regexp(regexpQuery);
}
...
public sealed partial class RegexpQueryDescriptor<TDocument> : SerializableDescriptor<RegexpQueryDescriptor<TDocument>>
{
	...
	public RegexpQueryDescriptor<TDocument> Field(Elastic.Clients.Elasticsearch.Serverless.Field field)
	{
		FieldValue = field;
		return Self;
	}
...
public sealed partial class RegexpQueryDescriptor : SerializableDescriptor<RegexpQueryDescriptor>
{
	...
	public RegexpQueryDescriptor Field(Elastic.Clients.Elasticsearch.Serverless.Field field)
	{
		FieldValue = field;
		return Self;
	}
