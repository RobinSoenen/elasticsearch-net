...
internal sealed partial class GeoDistanceQueryConverter : System.Text.Json.Serialization.JsonConverter<GeoDistanceQuery>
{
	...
	public override GeoDistanceQuery Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.GeoLocation> propLocation = default;
		LocalJsonProperty<float?> propBoost = default;
		LocalJsonProperty<string> propDistance = default;
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.GeoValidationMethod?> propValidationMethod = default;
...
public sealed partial class GeoDistanceQuery
{
	...
	public static implicit operator Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Query(GeoDistanceQuery geoDistanceQuery) => Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Query.GeoDistance(geoDistanceQuery);
}
