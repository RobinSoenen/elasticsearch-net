	...
	public override Retriever Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		while (reader.Read() && reader.TokenType is System.Text.Json.JsonTokenType.PropertyName)
		{
			if (reader.ValueTextEquals(VariantKnn))
			{
				...
				reader.Read();
				variant = reader.ReadValue<Elastic.Clients.Elasticsearch.Serverless.KnnRetriever?>(options);
				continue;
			}
			...
			if (reader.ValueTextEquals(VariantRrf))
			{
				...
				reader.Read();
				variant = reader.ReadValue<Elastic.Clients.Elasticsearch.Serverless.RRFRetriever?>(options);
				continue;
			}
			...
			if (reader.ValueTextEquals(VariantRule))
			{
				...
				reader.Read();
				variant = reader.ReadValue<Elastic.Clients.Elasticsearch.Serverless.RuleRetriever?>(options);
				continue;
			}
			...
			if (reader.ValueTextEquals(VariantStandard))
			{
				...
				reader.Read();
				variant = reader.ReadValue<Elastic.Clients.Elasticsearch.Serverless.StandardRetriever?>(options);
				continue;
			}
			...
			if (reader.ValueTextEquals(VariantTextSimilarityReranker))
			{
				...
				reader.Read();
				variant = reader.ReadValue<Elastic.Clients.Elasticsearch.Serverless.TextSimilarityReranker?>(options);
				continue;
			}
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, Retriever value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		switch (value.VariantType)
		{
			case "":
				break;
			case "knn":
				writer.WriteProperty(options, value.VariantType, (Elastic.Clients.Elasticsearch.Serverless.KnnRetriever?)value.Variant);
				break;
			case "rrf":
				writer.WriteProperty(options, value.VariantType, (Elastic.Clients.Elasticsearch.Serverless.RRFRetriever?)value.Variant);
				break;
			case "rule":
				writer.WriteProperty(options, value.VariantType, (Elastic.Clients.Elasticsearch.Serverless.RuleRetriever?)value.Variant);
				break;
			case "standard":
				writer.WriteProperty(options, value.VariantType, (Elastic.Clients.Elasticsearch.Serverless.StandardRetriever?)value.Variant);
				break;
			case "text_similarity_reranker":
				writer.WriteProperty(options, value.VariantType, (Elastic.Clients.Elasticsearch.Serverless.TextSimilarityReranker?)value.Variant);
				break;
			default:
