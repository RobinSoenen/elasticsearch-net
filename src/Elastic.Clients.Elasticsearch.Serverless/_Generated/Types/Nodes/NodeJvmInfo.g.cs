...
internal sealed partial class NodeJvmInfoConverter : System.Text.Json.Serialization.JsonConverter<NodeJvmInfo>
{
	...
	public override NodeJvmInfo Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<IReadOnlyCollection<string>> propGcCollectors = default;
		LocalJsonProperty<IReadOnlyCollection<string>> propInputArguments = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Nodes.NodeInfoJvmMemory> propMem = default;
		LocalJsonProperty<IReadOnlyCollection<string>> propMemoryPools = default;
		LocalJsonProperty<int> propPid = default;
		LocalJsonProperty<long> propStartTimeInMillis = default;
		LocalJsonProperty<bool> propUsingBundledJdk = default;
		LocalJsonProperty<object?> propUsingCompressedOrdinaryObjectPointers = default;
		LocalJsonProperty<string> propVersion = default;
		LocalJsonProperty<string> propVmName = default;
		LocalJsonProperty<string> propVmVendor = default;
		LocalJsonProperty<string> propVmVersion = default;
...
public sealed partial class NodeJvmInfo
{
	...
	public Elastic.Clients.Elasticsearch.Serverless.Nodes.NodeInfoJvmMemory Mem { get; init; }
