...
internal sealed partial class StatsConverter : System.Text.Json.Serialization.JsonConverter<Stats>
{
	...
	public override Stats Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<IReadOnlyDictionary<string, Elastic.Clients.Elasticsearch.Serverless.Nodes.AdaptiveSelection>?> propAdaptiveSelection = default;
		LocalJsonProperty<IReadOnlyDictionary<Elastic.Clients.Elasticsearch.Serverless.Field, string>?> propAttributes = default;
		LocalJsonProperty<IReadOnlyDictionary<string, Elastic.Clients.Elasticsearch.Serverless.Nodes.Breaker>?> propBreakers = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Nodes.Discovery?> propDiscovery = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Nodes.FileSystem?> propFs = default;
		LocalJsonProperty<string?> propHost = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Nodes.Http?> propHttp = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Nodes.IndexingPressure?> propIndexingPressure = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.IndexManagement.ShardStats?> propIndices = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Nodes.Ingest?> propIngest = default;
		LocalJsonProperty<IReadOnlyCollection<string>?> propIp = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Nodes.Jvm?> propJvm = default;
		LocalJsonProperty<string?> propName = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Nodes.OperatingSystem?> propOs = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Nodes.Process?> propProcess = default;
		LocalJsonProperty<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.NodeRole>?> propRoles = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Nodes.Scripting?> propScript = default;
		LocalJsonProperty<IReadOnlyDictionary<string, Union<Elastic.Clients.Elasticsearch.Serverless.Nodes.ScriptCache, IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.Nodes.ScriptCache>>>?> propScriptCache = default;
		LocalJsonProperty<IReadOnlyDictionary<string, Elastic.Clients.Elasticsearch.Serverless.Nodes.ThreadCount>?> propThreadPool = default;
		LocalJsonProperty<long?> propTimestamp = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Nodes.Transport?> propTransport = default;
		LocalJsonProperty<string?> propTransportAddress = default;
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, Stats value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		writer.WriteProperty(options, PropIp, value.Ip, typeof(SingleOrManyMarker<IReadOnlyCollection<string>?, string>));
...
public sealed partial class Stats
{
	...
	/// </para>
	/// </summary>
	public IReadOnlyDictionary<string, Elastic.Clients.Elasticsearch.Serverless.Nodes.AdaptiveSelection>? AdaptiveSelection { get; init; }
	...
	/// </para>
	/// </summary>
	public IReadOnlyDictionary<Elastic.Clients.Elasticsearch.Serverless.Field, string>? Attributes { get; init; }
	...
	/// </para>
	/// </summary>
	public IReadOnlyDictionary<string, Elastic.Clients.Elasticsearch.Serverless.Nodes.Breaker>? Breakers { get; init; }
	...
	/// </para>
	/// </summary>
	public Elastic.Clients.Elasticsearch.Serverless.Nodes.Discovery? Discovery { get; init; }
	...
	/// </para>
	/// </summary>
	public Elastic.Clients.Elasticsearch.Serverless.Nodes.FileSystem? Fs { get; init; }
	...
	/// </para>
	/// </summary>
	public Elastic.Clients.Elasticsearch.Serverless.Nodes.IndexingPressure? IndexingPressure { get; init; }
	...
	/// </para>
	/// </summary>
	public Elastic.Clients.Elasticsearch.Serverless.IndexManagement.ShardStats? Indices { get; init; }
	...
	/// </para>
	/// </summary>
	public Elastic.Clients.Elasticsearch.Serverless.Nodes.Jvm? Jvm { get; init; }
	...
	/// </para>
	/// </summary>
	public Elastic.Clients.Elasticsearch.Serverless.Nodes.OperatingSystem? Os { get; init; }
	...
	/// </para>
	/// </summary>
	public Elastic.Clients.Elasticsearch.Serverless.Nodes.Process? Process { get; init; }
	...
	public IReadOnlyDictionary<string, Union<Elastic.Clients.Elasticsearch.Serverless.Nodes.ScriptCache, IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.Nodes.ScriptCache>>>? ScriptCache { get; init; }
	...
	/// </para>
	/// </summary>
	public Elastic.Clients.Elasticsearch.Serverless.Nodes.Transport? Transport { get; init; }
