...
internal sealed partial class AddActionConverter : System.Text.Json.Serialization.JsonConverter<AddAction>
{
	...
	public override AddAction Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.IndexAlias?> propAlias = default;
		LocalJsonProperty<ICollection<Elastic.Clients.Elasticsearch.Serverless.IndexAlias>?> propAliases = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Query?> propFilter = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.IndexName?> propIndex = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Routing?> propIndexRouting = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Indices?> propIndices = default;
		LocalJsonProperty<bool?> propIsHidden = default;
		LocalJsonProperty<bool?> propIsWriteIndex = default;
		LocalJsonProperty<bool?> propMustExist = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Routing?> propRouting = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Routing?> propSearchRouting = default;
		while (reader.Read() && reader.TokenType is System.Text.Json.JsonTokenType.PropertyName)
		{
			...
			if (propAliases.TryRead(ref reader, options, PropAliases, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.IndexAlias>?, Elastic.Clients.Elasticsearch.Serverless.IndexAlias>)))
			{
				continue;
			}
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, AddAction value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		writer.WriteProperty(options, PropAliases, value.Aliases, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.IndexAlias>?, Elastic.Clients.Elasticsearch.Serverless.IndexAlias>));
