...
{
	private static readonly System.Text.Json.JsonEncodedText PropOtherSettings = System.Text.Json.JsonEncodedText.Encode("other_settings");
	...
	public override IndexSettings Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.IndexManagement.IndexSettingsAnalysis?> propAnalysis = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.IndexManagement.SettingsAnalyze?> propAnalyze = default;
		LocalJsonProperty<string?> propAutoExpandReplicas = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.IndexManagement.IndexSettingBlocks?> propBlocks = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.IndexManagement.IndexCheckOnStartup?> propCheckOnStartup = default;
		LocalJsonProperty<string?> propCodec = default;
		LocalJsonProperty<long?> propCreationDate = default;
		LocalJsonProperty<DateTimeOffset?> propCreationDateString = default;
		LocalJsonProperty<string?> propDefaultPipeline = default;
		LocalJsonProperty<string?> propFinalPipeline = default;
		LocalJsonProperty<object?> propFormat = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Duration?> propGcDeletes = default;
		LocalJsonProperty<object?> propHidden = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.IndexManagement.SettingsHighlight?> propHighlight = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.IndexManagement.IndexSettings?> propIndex = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.IndexManagement.IndexingPressure?> propIndexingPressure = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.IndexManagement.IndexingSlowlogSettings?> propIndexingSlowlog = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.IndexManagement.IndexSettingsLifecycle?> propLifecycle = default;
		LocalJsonProperty<bool?> propLoadFixedBitsetFiltersEagerly = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.IndexManagement.MappingLimitSettings?> propMapping = default;
		LocalJsonProperty<int?> propMaxDocvalueFieldsSearch = default;
		LocalJsonProperty<int?> propMaxInnerResultWindow = default;
		LocalJsonProperty<int?> propMaxNgramDiff = default;
		LocalJsonProperty<int?> propMaxRefreshListeners = default;
		LocalJsonProperty<int?> propMaxRegexLength = default;
		LocalJsonProperty<int?> propMaxRescoreWindow = default;
		LocalJsonProperty<int?> propMaxResultWindow = default;
		LocalJsonProperty<int?> propMaxScriptFields = default;
		LocalJsonProperty<int?> propMaxShingleDiff = default;
		LocalJsonProperty<int?> propMaxSlicesPerScroll = default;
		LocalJsonProperty<int?> propMaxTermsCount = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.IndexManagement.Merge?> propMerge = default;
		LocalJsonProperty<string?> propMode = default;
		LocalJsonProperty<object?> propNumberOfReplicas = default;
		LocalJsonProperty<int?> propNumberOfRoutingShards = default;
		LocalJsonProperty<object?> propNumberOfShards = default;
		LocalJsonProperty<object?> propPriority = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Name?> propProvidedName = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.IndexManagement.Queries?> propQueries = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.IndexManagement.SettingsQueryString?> propQueryString = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Duration?> propRefreshInterval = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.IndexManagement.IndexRouting?> propRouting = default;
		LocalJsonProperty<int?> propRoutingPartitionSize = default;
		LocalJsonProperty<ICollection<string>?> propRoutingPath = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.IndexManagement.SettingsSearch?> propSearch = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.IndexManagement.IndexSettings?> propSettings = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.IndexManagement.SettingsSimilarities?> propSimilarity = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.IndexManagement.SoftDeletes?> propSoftDeletes = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.IndexManagement.IndexSegmentSort?> propSort = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.IndexManagement.Storage?> propStore = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.IndexManagement.IndexSettingsTimeSeries?> propTimeSeries = default;
		LocalJsonProperty<int?> propTopMetricsMaxSize = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.IndexManagement.Translog?> propTranslog = default;
		LocalJsonProperty<string?> propUuid = default;
		LocalJsonProperty<object?> propVerifiedBeforeClose = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.IndexManagement.IndexVersioning?> propVersion = default;
		while (reader.Read() && reader.TokenType is System.Text.Json.JsonTokenType.PropertyName)
		{
			...
			if (propRoutingPath.TryRead(ref reader, options, PropRoutingPath, typeof(SingleOrManyMarker<IReadOnlyCollection<string>?, string>)))
			{
				continue;
			}
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, IndexSettings value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		writer.WriteProperty(options, PropRoutingPath, value.RoutingPath, typeof(SingleOrManyMarker<IReadOnlyCollection<string>?, string>));
