...
internal sealed partial class ExplainAnalyzeTokenConverter : System.Text.Json.Serialization.JsonConverter<ExplainAnalyzeToken>
{
	...
	public override ExplainAnalyzeToken Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<string> propBytes = default;
		LocalJsonProperty<long> propEndOffset = default;
		LocalJsonProperty<bool?> propKeyword = default;
		LocalJsonProperty<long> propPosition = default;
		LocalJsonProperty<long> propPositionlength = default;
		LocalJsonProperty<long> propStartOffset = default;
		LocalJsonProperty<long> propTermfrequency = default;
		LocalJsonProperty<string> propToken = default;
