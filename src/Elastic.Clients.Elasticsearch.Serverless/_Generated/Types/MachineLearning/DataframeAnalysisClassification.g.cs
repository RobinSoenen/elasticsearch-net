...
internal sealed partial class DataframeAnalysisClassificationConverter : System.Text.Json.Serialization.JsonConverter<DataframeAnalysisClassification>
{
	...
	public override DataframeAnalysisClassification Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<double?> propAlpha = default;
		LocalJsonProperty<string?> propClassAssignmentObjective = default;
		LocalJsonProperty<string> propDependentVariable = default;
		LocalJsonProperty<double?> propDownsampleFactor = default;
		LocalJsonProperty<bool?> propEarlyStoppingEnabled = default;
		LocalJsonProperty<double?> propEta = default;
		LocalJsonProperty<double?> propEtaGrowthRatePerTree = default;
		LocalJsonProperty<double?> propFeatureBagFraction = default;
		LocalJsonProperty<ICollection<Elastic.Clients.Elasticsearch.Serverless.MachineLearning.DataframeAnalysisFeatureProcessor>?> propFeatureProcessors = default;
		LocalJsonProperty<double?> propGamma = default;
		LocalJsonProperty<double?> propLambda = default;
		LocalJsonProperty<int?> propMaxOptimizationRoundsPerHyperparameter = default;
		LocalJsonProperty<int?> propMaxTrees = default;
		LocalJsonProperty<int?> propNumTopClasses = default;
		LocalJsonProperty<int?> propNumTopFeatureImportanceValues = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Field?> propPredictionFieldName = default;
		LocalJsonProperty<double?> propRandomizeSeed = default;
		LocalJsonProperty<int?> propSoftTreeDepthLimit = default;
		LocalJsonProperty<double?> propSoftTreeDepthTolerance = default;
		LocalJsonProperty<double?> propTrainingPercent = default;
