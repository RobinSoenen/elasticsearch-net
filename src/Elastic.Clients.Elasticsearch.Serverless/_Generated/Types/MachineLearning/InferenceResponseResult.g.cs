...
internal sealed partial class InferenceResponseResultConverter : System.Text.Json.Serialization.JsonConverter<InferenceResponseResult>
{
	...
	public override InferenceResponseResult Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.MachineLearning.TrainedModelEntities>?> propEntities = default;
		LocalJsonProperty<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.MachineLearning.TrainedModelInferenceFeatureImportance>?> propFeatureImportance = default;
		LocalJsonProperty<bool?> propIsTruncated = default;
		LocalJsonProperty<IReadOnlyCollection<object>?> propPredictedValue = default;
		LocalJsonProperty<string?> propPredictedValueSequence = default;
		LocalJsonProperty<double?> propPredictionProbability = default;
		LocalJsonProperty<double?> propPredictionScore = default;
		LocalJsonProperty<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.MachineLearning.TopClassEntry>?> propTopClasses = default;
		LocalJsonProperty<string?> propWarning = default;
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, InferenceResponseResult value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		writer.WriteProperty(options, PropPredictedValue, value.PredictedValue, typeof(SingleOrManyMarker<IReadOnlyCollection<object>?, object>));
