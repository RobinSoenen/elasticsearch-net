	...
	public override InferenceConfigCreate Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		while (reader.Read() && reader.TokenType is System.Text.Json.JsonTokenType.PropertyName)
		{
			...
			if (reader.ValueTextEquals(VariantFillMask))
			{
				...
				reader.Read();
				variant = reader.ReadValue<Elastic.Clients.Elasticsearch.Serverless.MachineLearning.FillMaskInferenceOptions?>(options);
				continue;
			}
			...
			if (reader.ValueTextEquals(VariantNer))
			{
				...
				reader.Read();
				variant = reader.ReadValue<Elastic.Clients.Elasticsearch.Serverless.MachineLearning.NerInferenceOptions?>(options);
				continue;
			}
			...
			if (reader.ValueTextEquals(VariantPassThrough))
			{
				...
				reader.Read();
				variant = reader.ReadValue<Elastic.Clients.Elasticsearch.Serverless.MachineLearning.PassThroughInferenceOptions?>(options);
				continue;
			}
			...
			if (reader.ValueTextEquals(VariantQuestionAnswering))
			{
				...
				reader.Read();
				variant = reader.ReadValue<Elastic.Clients.Elasticsearch.Serverless.MachineLearning.QuestionAnsweringInferenceOptions?>(options);
				continue;
			}
			...
			if (reader.ValueTextEquals(VariantTextClassification))
			{
				...
				reader.Read();
				variant = reader.ReadValue<Elastic.Clients.Elasticsearch.Serverless.MachineLearning.TextClassificationInferenceOptions?>(options);
				continue;
			}
			...
			if (reader.ValueTextEquals(VariantTextEmbedding))
			{
				...
				reader.Read();
				variant = reader.ReadValue<Elastic.Clients.Elasticsearch.Serverless.MachineLearning.TextEmbeddingInferenceOptions?>(options);
				continue;
			}
			...
			if (reader.ValueTextEquals(VariantTextExpansion))
			{
				...
				reader.Read();
				variant = reader.ReadValue<Elastic.Clients.Elasticsearch.Serverless.MachineLearning.TextExpansionInferenceOptions?>(options);
				continue;
			}
			...
			if (reader.ValueTextEquals(VariantZeroShotClassification))
			{
				...
				reader.Read();
				variant = reader.ReadValue<Elastic.Clients.Elasticsearch.Serverless.MachineLearning.ZeroShotClassificationInferenceOptions?>(options);
				continue;
			}
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, InferenceConfigCreate value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		switch (value.VariantType)
		{
			...
			case "classification":
				...
				break;
			case "fill_mask":
				writer.WriteProperty(options, value.VariantType, (Elastic.Clients.Elasticsearch.Serverless.MachineLearning.FillMaskInferenceOptions?)value.Variant);
				break;
			case "ner":
				writer.WriteProperty(options, value.VariantType, (Elastic.Clients.Elasticsearch.Serverless.MachineLearning.NerInferenceOptions?)value.Variant);
				break;
			case "pass_through":
				writer.WriteProperty(options, value.VariantType, (Elastic.Clients.Elasticsearch.Serverless.MachineLearning.PassThroughInferenceOptions?)value.Variant);
				break;
			case "question_answering":
				writer.WriteProperty(options, value.VariantType, (Elastic.Clients.Elasticsearch.Serverless.MachineLearning.QuestionAnsweringInferenceOptions?)value.Variant);
				break;
			case "regression":
			...
			case "text_classification":
				writer.WriteProperty(options, value.VariantType, (Elastic.Clients.Elasticsearch.Serverless.MachineLearning.TextClassificationInferenceOptions?)value.Variant);
				break;
			case "text_embedding":
				writer.WriteProperty(options, value.VariantType, (Elastic.Clients.Elasticsearch.Serverless.MachineLearning.TextEmbeddingInferenceOptions?)value.Variant);
				break;
			case "text_expansion":
				writer.WriteProperty(options, value.VariantType, (Elastic.Clients.Elasticsearch.Serverless.MachineLearning.TextExpansionInferenceOptions?)value.Variant);
				break;
			case "zero_shot_classification":
				writer.WriteProperty(options, value.VariantType, (Elastic.Clients.Elasticsearch.Serverless.MachineLearning.ZeroShotClassificationInferenceOptions?)value.Variant);
				break;
			default:
