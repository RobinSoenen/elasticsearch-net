...
internal sealed partial class ShapePropertyConverter : System.Text.Json.Serialization.JsonConverter<ShapeProperty>
{
	...
	public override ShapeProperty Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Mapping.GeoOrientation?> propOrientation = default;
		...
		while (reader.Read() && reader.TokenType is System.Text.Json.JsonTokenType.PropertyName)
		{
			...
			if (propOrientation.TryRead(ref reader, options, PropOrientation))
			{
				continue;
			}
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, ShapeProperty value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		writer.WriteProperty(options, PropOrientation, value.Orientation);
...
/// </summary>
[JsonConverter(typeof(ShapePropertyConverter))]
...
public sealed partial class ShapePropertyDescriptor<TDocument> : SerializableDescriptor<ShapePropertyDescriptor<TDocument>>, IBuildableDescriptor<ShapeProperty>
{
	...
	public ShapePropertyDescriptor<TDocument> CopyTo(Elastic.Clients.Elasticsearch.Serverless.Fields? copyTo)
	{
		CopyToValue = copyTo;
		return Self;
	}
	...
	public ShapePropertyDescriptor<TDocument> Dynamic(Elastic.Clients.Elasticsearch.Serverless.Mapping.DynamicMapping? dynamic)
	{
		DynamicValue = dynamic;
		return Self;
	}

	public ShapePropertyDescriptor<TDocument> Fields(Elastic.Clients.Elasticsearch.Serverless.Mapping.Properties? fields)
	{
		FieldsValue = fields;
		return Self;
	}
	...
	public ShapePropertyDescriptor<TDocument> Orientation(Elastic.Clients.Elasticsearch.Serverless.Mapping.GeoOrientation? orientation)
	{
		OrientationValue = orientation;
		return Self;
	}

	public ShapePropertyDescriptor<TDocument> Properties(Elastic.Clients.Elasticsearch.Serverless.Mapping.Properties? properties)
	{
...
public sealed partial class ShapePropertyDescriptor : SerializableDescriptor<ShapePropertyDescriptor>, IBuildableDescriptor<ShapeProperty>
{
	...
	public ShapePropertyDescriptor CopyTo(Elastic.Clients.Elasticsearch.Serverless.Fields? copyTo)
	{
		CopyToValue = copyTo;
		return Self;
	}
	...
	public ShapePropertyDescriptor Dynamic(Elastic.Clients.Elasticsearch.Serverless.Mapping.DynamicMapping? dynamic)
	{
		DynamicValue = dynamic;
		return Self;
	}

	public ShapePropertyDescriptor Fields(Elastic.Clients.Elasticsearch.Serverless.Mapping.Properties? fields)
	{
		FieldsValue = fields;
		return Self;
	}
	...
	public ShapePropertyDescriptor Orientation(Elastic.Clients.Elasticsearch.Serverless.Mapping.GeoOrientation? orientation)
	{
		OrientationValue = orientation;
		return Self;
	}

	public ShapePropertyDescriptor Properties(Elastic.Clients.Elasticsearch.Serverless.Mapping.Properties? properties)
	{
		PropertiesValue = properties;
		return Self;
	}
