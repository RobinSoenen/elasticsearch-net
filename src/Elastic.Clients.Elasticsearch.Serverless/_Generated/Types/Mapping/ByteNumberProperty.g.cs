...
internal sealed partial class ByteNumberPropertyConverter : System.Text.Json.Serialization.JsonConverter<ByteNumberProperty>
{
	...
	public override ByteNumberProperty Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<byte?> propNullValue = default;
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, ByteNumberProperty value, System.Text.Json.JsonSerializerOptions options)
	{
...
[JsonConverter(typeof(ByteNumberPropertyConverter))]
