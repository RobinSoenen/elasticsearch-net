...
internal sealed partial class SignificantTextAggregationConverter : System.Text.Json.Serialization.JsonConverter<SignificantTextAggregation>
{
	...
	public override SignificantTextAggregation Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Query?> propBackgroundFilter = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Aggregations.ChiSquareHeuristic?> propChiSquare = default;
		...
		LocalJsonProperty<bool?> propFilterDuplicateText = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Aggregations.GoogleNormalizedDistanceHeuristic?> propGnd = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Aggregations.TermsInclude?> propInclude = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.EmptyObject?> propJlh = default;
		LocalJsonProperty<long?> propMinDocCount = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Aggregations.MutualInformationHeuristic?> propMutualInformation = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Aggregations.PercentageScoreHeuristic?> propPercentage = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Aggregations.ScriptedHeuristic?> propScriptHeuristic = default;
