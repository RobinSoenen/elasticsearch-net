...
internal sealed partial class TermsAggregationConverter : System.Text.Json.Serialization.JsonConverter<TermsAggregation>
{
	...
	public override TermsAggregation Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Aggregations.TermsAggregationCollectMode?> propCollectMode = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Aggregations.TermsExclude?> propExclude = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Aggregations.TermsAggregationExecutionHint?> propExecutionHint = default;
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Aggregations.TermsInclude?> propInclude = default;
		...
		LocalJsonProperty<bool?> propMissingBucket = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Aggregations.MissingOrder?> propMissingOrder = default;
		LocalJsonProperty<ICollection<KeyValuePair<Elastic.Clients.Elasticsearch.Serverless.Field, Elastic.Clients.Elasticsearch.Serverless.SortOrder>>?> propOrder = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Script?> propScript = default;
		LocalJsonProperty<long?> propShardMinDocCount = default;
		LocalJsonProperty<int?> propShardSize = default;
		LocalJsonProperty<bool?> propShowTermDocCountError = default;
		LocalJsonProperty<int?> propSize = default;
		LocalJsonProperty<string?> propValueType = default;
		while (reader.Read() && reader.TokenType is System.Text.Json.JsonTokenType.PropertyName)
		{
			...
			if (propOrder.TryRead(ref reader, options, PropOrder, typeof(SingleOrManyMarker<IReadOnlyCollection<KeyValuePair<Elastic.Clients.Elasticsearch.Serverless.Field, Elastic.Clients.Elasticsearch.Serverless.SortOrder>>?, KeyValuePair<Elastic.Clients.Elasticsearch.Serverless.Field, Elastic.Clients.Elasticsearch.Serverless.SortOrder>>)))
			{
				continue;
			}
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, TermsAggregation value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		writer.WriteProperty(options, PropOrder, value.Order, typeof(SingleOrManyMarker<IReadOnlyCollection<KeyValuePair<Elastic.Clients.Elasticsearch.Serverless.Field, Elastic.Clients.Elasticsearch.Serverless.SortOrder>>?, KeyValuePair<Elastic.Clients.Elasticsearch.Serverless.Field, Elastic.Clients.Elasticsearch.Serverless.SortOrder>>));
...
public sealed partial class TermsAggregation
{
	...
	public static implicit operator Elastic.Clients.Elasticsearch.Serverless.Security.ApiKeyAggregation(TermsAggregation termsAggregation) => Elastic.Clients.Elasticsearch.Serverless.Security.ApiKeyAggregation.Terms(termsAggregation);
...
public sealed partial class TermsAggregationDescriptor<TDocument> : SerializableDescriptor<TermsAggregationDescriptor<TDocument>>
{
	...
	public TermsAggregationDescriptor<TDocument> Script(Elastic.Clients.Elasticsearch.Serverless.ScriptDescriptor descriptor)
	{
		ScriptValue = null;
		ScriptDescriptorAction = null;
	...
	public TermsAggregationDescriptor<TDocument> Script(Action<Elastic.Clients.Elasticsearch.Serverless.ScriptDescriptor> configure)
	{
		ScriptValue = null;
		ScriptDescriptor = null;
...
public sealed partial class TermsAggregationDescriptor : SerializableDescriptor<TermsAggregationDescriptor>
{
	...
	public TermsAggregationDescriptor Script(Elastic.Clients.Elasticsearch.Serverless.ScriptDescriptor descriptor)
	{
		ScriptValue = null;
		ScriptDescriptorAction = null;
		ScriptDescriptor = descriptor;
	...
	public TermsAggregationDescriptor Script(Action<Elastic.Clients.Elasticsearch.Serverless.ScriptDescriptor> configure)
	{
		ScriptValue = null;
		ScriptDescriptor = null;
		ScriptDescriptorAction = configure;
