...
internal sealed partial class InferenceAggregateConverter : System.Text.Json.Serialization.JsonConverter<InferenceAggregate>
{
	...
	public override InferenceAggregate Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.Aggregations.InferenceFeatureImportance>?> propFeatureImportance = default;
		LocalJsonProperty<IReadOnlyDictionary<string, object>?> propMeta = default;
		LocalJsonProperty<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.Aggregations.InferenceTopClassEntry>?> propTopClasses = default;
