...
internal sealed partial class CatalanAnalyzerConverter : System.Text.Json.Serialization.JsonConverter<CatalanAnalyzer>
{
	...
	public override CatalanAnalyzer Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, CatalanAnalyzer value, System.Text.Json.JsonSerializerOptions options)
	{
...
[JsonConverter(typeof(CatalanAnalyzerConverter))]
public sealed partial class CatalanAnalyzer : IAnalyzer
{
...
public sealed partial class CatalanAnalyzerDescriptor : SerializableDescriptor<CatalanAnalyzerDescriptor>, IBuildableDescriptor<CatalanAnalyzer>
{
	internal CatalanAnalyzerDescriptor(Action<CatalanAnalyzerDescriptor> configure) => configure.Invoke(this);

	public CatalanAnalyzerDescriptor() : base()
	{
	}
	...
	public CatalanAnalyzerDescriptor StemExclusion(ICollection<string>? stemExclusion)
	{
		StemExclusionValue = stemExclusion;
		return Self;
	}

	public CatalanAnalyzerDescriptor Stopwords(ICollection<string>? stopwords)
	{
		StopwordsValue = stopwords;
		return Self;
	}

	public CatalanAnalyzerDescriptor StopwordsPath(string? stopwordsPath)
	{
	...
	CatalanAnalyzer IBuildableDescriptor<CatalanAnalyzer>.Build() => new()
	{
