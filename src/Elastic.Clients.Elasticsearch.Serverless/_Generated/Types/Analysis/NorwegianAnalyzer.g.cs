...
internal sealed partial class NorwegianAnalyzerConverter : System.Text.Json.Serialization.JsonConverter<NorwegianAnalyzer>
{
	...
	public override NorwegianAnalyzer Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, NorwegianAnalyzer value, System.Text.Json.JsonSerializerOptions options)
	{
...
[JsonConverter(typeof(NorwegianAnalyzerConverter))]
public sealed partial class NorwegianAnalyzer : IAnalyzer
{
	public ICollection<string>? StemExclusion { get; set; }
	public ICollection<string>? Stopwords { get; set; }
	public string? StopwordsPath { get; set; }

	public string Type => "norwegian";
}

public sealed partial class NorwegianAnalyzerDescriptor : SerializableDescriptor<NorwegianAnalyzerDescriptor>, IBuildableDescriptor<NorwegianAnalyzer>
{
	internal NorwegianAnalyzerDescriptor(Action<NorwegianAnalyzerDescriptor> configure) => configure.Invoke(this);

	public NorwegianAnalyzerDescriptor() : base()
	{
	}
	...
	public NorwegianAnalyzerDescriptor StemExclusion(ICollection<string>? stemExclusion)
	{
		StemExclusionValue = stemExclusion;
		return Self;
	}

	public NorwegianAnalyzerDescriptor Stopwords(ICollection<string>? stopwords)
	{
		StopwordsValue = stopwords;
		return Self;
	}

	public NorwegianAnalyzerDescriptor StopwordsPath(string? stopwordsPath)
	{
	...
	NorwegianAnalyzer IBuildableDescriptor<NorwegianAnalyzer>.Build() => new()
	{
