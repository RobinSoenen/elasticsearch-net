...
internal sealed partial class TurkishAnalyzerConverter : System.Text.Json.Serialization.JsonConverter<TurkishAnalyzer>
{
	...
	public override TurkishAnalyzer Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, TurkishAnalyzer value, System.Text.Json.JsonSerializerOptions options)
	{
...
[JsonConverter(typeof(TurkishAnalyzerConverter))]
...
public sealed partial class TurkishAnalyzerDescriptor : SerializableDescriptor<TurkishAnalyzerDescriptor>, IBuildableDescriptor<TurkishAnalyzer>
{
	...
	public TurkishAnalyzerDescriptor Stopwords(ICollection<string>? stopwords)
	{
