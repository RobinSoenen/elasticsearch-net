...
internal sealed partial class IrishAnalyzerConverter : System.Text.Json.Serialization.JsonConverter<IrishAnalyzer>
{
	...
	public override IrishAnalyzer Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, IrishAnalyzer value, System.Text.Json.JsonSerializerOptions options)
	{
...
[JsonConverter(typeof(IrishAnalyzerConverter))]
