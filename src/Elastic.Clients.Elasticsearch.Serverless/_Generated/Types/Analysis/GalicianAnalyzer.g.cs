...
internal sealed partial class GalicianAnalyzerConverter : System.Text.Json.Serialization.JsonConverter<GalicianAnalyzer>
{
	...
	public override GalicianAnalyzer Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, GalicianAnalyzer value, System.Text.Json.JsonSerializerOptions options)
	{
...
[JsonConverter(typeof(GalicianAnalyzerConverter))]
public sealed partial class GalicianAnalyzer : IAnalyzer
{
...
public sealed partial class GalicianAnalyzerDescriptor : SerializableDescriptor<GalicianAnalyzerDescriptor>, IBuildableDescriptor<GalicianAnalyzer>
{
	internal GalicianAnalyzerDescriptor(Action<GalicianAnalyzerDescriptor> configure) => configure.Invoke(this);

	public GalicianAnalyzerDescriptor() : base()
	{
	}
	...
	public GalicianAnalyzerDescriptor StemExclusion(ICollection<string>? stemExclusion)
	{
		StemExclusionValue = stemExclusion;
		return Self;
	}

	public GalicianAnalyzerDescriptor Stopwords(ICollection<string>? stopwords)
	{
		StopwordsValue = stopwords;
		return Self;
	}

	public GalicianAnalyzerDescriptor StopwordsPath(string? stopwordsPath)
	{
	...
	GalicianAnalyzer IBuildableDescriptor<GalicianAnalyzer>.Build() => new()
	{
