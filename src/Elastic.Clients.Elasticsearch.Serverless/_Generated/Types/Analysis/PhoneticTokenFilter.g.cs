...
internal sealed partial class PhoneticTokenFilterConverter : System.Text.Json.Serialization.JsonConverter<PhoneticTokenFilter>
{
	...
	public override PhoneticTokenFilter Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Analysis.PhoneticEncoder> propEncoder = default;
		LocalJsonProperty<ICollection<Elastic.Clients.Elasticsearch.Serverless.Analysis.PhoneticLanguage>?> propLanguageset = default;
		LocalJsonProperty<int?> propMaxCodeLen = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Analysis.PhoneticNameType?> propNameType = default;
		LocalJsonProperty<bool?> propReplace = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Analysis.PhoneticRuleType?> propRuleType = default;
		LocalJsonProperty<string?> propVersion = default;
		while (reader.Read() && reader.TokenType is System.Text.Json.JsonTokenType.PropertyName)
		{
			...
			if (propLanguageset.TryRead(ref reader, options, PropLanguageset, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.Analysis.PhoneticLanguage>?, Elastic.Clients.Elasticsearch.Serverless.Analysis.PhoneticLanguage>)))
			{
				continue;
			}
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, PhoneticTokenFilter value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		writer.WriteProperty(options, PropLanguageset, value.Languageset, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.Analysis.PhoneticLanguage>?, Elastic.Clients.Elasticsearch.Serverless.Analysis.PhoneticLanguage>));
...
{
	public Elastic.Clients.Elasticsearch.Serverless.Analysis.PhoneticEncoder Encoder { get; set; }
	public ICollection<Elastic.Clients.Elasticsearch.Serverless.Analysis.PhoneticLanguage>? Languageset { get; set; }
	public int? MaxCodeLen { get; set; }
	public Elastic.Clients.Elasticsearch.Serverless.Analysis.PhoneticNameType? NameType { get; set; }
	public bool? Replace { get; set; }
	public Elastic.Clients.Elasticsearch.Serverless.Analysis.PhoneticRuleType? RuleType { get; set; }
...
public sealed partial class PhoneticTokenFilterDescriptor : SerializableDescriptor<PhoneticTokenFilterDescriptor>, IBuildableDescriptor<PhoneticTokenFilter>
{
	...
	private Elastic.Clients.Elasticsearch.Serverless.Analysis.PhoneticEncoder EncoderValue { get; set; }
	private ICollection<Elastic.Clients.Elasticsearch.Serverless.Analysis.PhoneticLanguage>? LanguagesetValue { get; set; }
	private int? MaxCodeLenValue { get; set; }
	private Elastic.Clients.Elasticsearch.Serverless.Analysis.PhoneticNameType? NameTypeValue { get; set; }
	private bool? ReplaceValue { get; set; }
	private Elastic.Clients.Elasticsearch.Serverless.Analysis.PhoneticRuleType? RuleTypeValue { get; set; }
	private string? VersionValue { get; set; }

	public PhoneticTokenFilterDescriptor Encoder(Elastic.Clients.Elasticsearch.Serverless.Analysis.PhoneticEncoder encoder)
	{
		EncoderValue = encoder;
		return Self;
	}

	public PhoneticTokenFilterDescriptor Languageset(ICollection<Elastic.Clients.Elasticsearch.Serverless.Analysis.PhoneticLanguage>? languageset)
	{
	...
	public PhoneticTokenFilterDescriptor NameType(Elastic.Clients.Elasticsearch.Serverless.Analysis.PhoneticNameType? nameType)
	{
	...
	public PhoneticTokenFilterDescriptor RuleType(Elastic.Clients.Elasticsearch.Serverless.Analysis.PhoneticRuleType? ruleType)
	{
	...
	protected override void Serialize(Utf8JsonWriter writer, JsonSerializerOptions options, IElasticsearchClientSettings settings)
	{
		...
		if (LanguagesetValue is not null)
		{
			...
			SingleOrManySerializationHelper.Serialize<Elastic.Clients.Elasticsearch.Serverless.Analysis.PhoneticLanguage>(LanguagesetValue, writer, options);
		}
