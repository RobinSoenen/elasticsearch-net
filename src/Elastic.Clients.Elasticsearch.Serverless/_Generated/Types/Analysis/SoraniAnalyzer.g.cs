...
internal sealed partial class SoraniAnalyzerConverter : System.Text.Json.Serialization.JsonConverter<SoraniAnalyzer>
{
	...
	public override SoraniAnalyzer Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, SoraniAnalyzer value, System.Text.Json.JsonSerializerOptions options)
	{
...
[JsonConverter(typeof(SoraniAnalyzerConverter))]
public sealed partial class SoraniAnalyzer : IAnalyzer
{
	public ICollection<string>? StemExclusion { get; set; }
	public ICollection<string>? Stopwords { get; set; }
	public string? StopwordsPath { get; set; }

	public string Type => "sorani";
}

public sealed partial class SoraniAnalyzerDescriptor : SerializableDescriptor<SoraniAnalyzerDescriptor>, IBuildableDescriptor<SoraniAnalyzer>
{
	internal SoraniAnalyzerDescriptor(Action<SoraniAnalyzerDescriptor> configure) => configure.Invoke(this);

	public SoraniAnalyzerDescriptor() : base()
	{
	}
	...
	public SoraniAnalyzerDescriptor StemExclusion(ICollection<string>? stemExclusion)
	{
		StemExclusionValue = stemExclusion;
		return Self;
	}

	public SoraniAnalyzerDescriptor Stopwords(ICollection<string>? stopwords)
	{
		StopwordsValue = stopwords;
		return Self;
	}

	public SoraniAnalyzerDescriptor StopwordsPath(string? stopwordsPath)
	{
	...
	SoraniAnalyzer IBuildableDescriptor<SoraniAnalyzer>.Build() => new()
	{
