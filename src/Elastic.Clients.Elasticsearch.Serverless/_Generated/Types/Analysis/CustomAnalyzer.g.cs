...
internal sealed partial class CustomAnalyzerConverter : System.Text.Json.Serialization.JsonConverter<CustomAnalyzer>
{
	...
	public override CustomAnalyzer Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<ICollection<string>?> propCharFilter = default;
		LocalJsonProperty<ICollection<string>?> propFilter = default;
		LocalJsonProperty<int?> propPositionIncrementGap = default;
		LocalJsonProperty<int?> propPositionOffsetGap = default;
		LocalJsonProperty<string> propTokenizer = default;
		while (reader.Read() && reader.TokenType is System.Text.Json.JsonTokenType.PropertyName)
		{
			if (propCharFilter.TryRead(ref reader, options, PropCharFilter, typeof(SingleOrManyMarker<IReadOnlyCollection<string>?, string>)))
			{
				continue;
			}

			if (propFilter.TryRead(ref reader, options, PropFilter, typeof(SingleOrManyMarker<IReadOnlyCollection<string>?, string>)))
			{
				continue;
			}
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, CustomAnalyzer value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		writer.WriteProperty(options, PropCharFilter, value.CharFilter, typeof(SingleOrManyMarker<IReadOnlyCollection<string>?, string>));
		writer.WriteProperty(options, PropFilter, value.Filter, typeof(SingleOrManyMarker<IReadOnlyCollection<string>?, string>));
