...
internal sealed partial class SerbianAnalyzerConverter : System.Text.Json.Serialization.JsonConverter<SerbianAnalyzer>
{
	...
	public override SerbianAnalyzer Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, SerbianAnalyzer value, System.Text.Json.JsonSerializerOptions options)
	{
...
[JsonConverter(typeof(SerbianAnalyzerConverter))]
public sealed partial class SerbianAnalyzer : IAnalyzer
{
	public ICollection<string>? StemExclusion { get; set; }
	public ICollection<string>? Stopwords { get; set; }
	public string? StopwordsPath { get; set; }

	public string Type => "serbian";
}

public sealed partial class SerbianAnalyzerDescriptor : SerializableDescriptor<SerbianAnalyzerDescriptor>, IBuildableDescriptor<SerbianAnalyzer>
{
	internal SerbianAnalyzerDescriptor(Action<SerbianAnalyzerDescriptor> configure) => configure.Invoke(this);

	public SerbianAnalyzerDescriptor() : base()
	{
	}
	...
	public SerbianAnalyzerDescriptor StemExclusion(ICollection<string>? stemExclusion)
	{
		StemExclusionValue = stemExclusion;
		return Self;
	}

	public SerbianAnalyzerDescriptor Stopwords(ICollection<string>? stopwords)
	{
		StopwordsValue = stopwords;
		return Self;
	}

	public SerbianAnalyzerDescriptor StopwordsPath(string? stopwordsPath)
	{
	...
	SerbianAnalyzer IBuildableDescriptor<SerbianAnalyzer>.Build() => new()
	{
