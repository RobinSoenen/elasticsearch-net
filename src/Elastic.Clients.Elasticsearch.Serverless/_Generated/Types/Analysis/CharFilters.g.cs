...
internal sealed partial class CharFilterInterfaceConverter : System.Text.Json.Serialization.JsonConverter<ICharFilter>
{
	...
	public override ICharFilter Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		{
			"html_strip" => reader.ReadValue<Elastic.Clients.Elasticsearch.Serverless.Analysis.HtmlStripCharFilter>(options),
			"icu_normalizer" => reader.ReadValue<Elastic.Clients.Elasticsearch.Serverless.Analysis.IcuNormalizationCharFilter>(options),
			"kuromoji_iteration_mark" => reader.ReadValue<Elastic.Clients.Elasticsearch.Serverless.Analysis.KuromojiIterationMarkCharFilter>(options),
			"mapping" => reader.ReadValue<Elastic.Clients.Elasticsearch.Serverless.Analysis.MappingCharFilter>(options),
			"pattern_replace" => reader.ReadValue<Elastic.Clients.Elasticsearch.Serverless.Analysis.PatternReplaceCharFilter>(options),
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, ICharFilter value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		{
			case "html_strip":
				writer.WriteValue(options, (Elastic.Clients.Elasticsearch.Serverless.Analysis.HtmlStripCharFilter)value);
				break;
			case "icu_normalizer":
				writer.WriteValue(options, (Elastic.Clients.Elasticsearch.Serverless.Analysis.IcuNormalizationCharFilter)value);
				break;
			case "kuromoji_iteration_mark":
				writer.WriteValue(options, (Elastic.Clients.Elasticsearch.Serverless.Analysis.KuromojiIterationMarkCharFilter)value);
				break;
			case "mapping":
				writer.WriteValue(options, (Elastic.Clients.Elasticsearch.Serverless.Analysis.MappingCharFilter)value);
				break;
			case "pattern_replace":
				writer.WriteValue(options, (Elastic.Clients.Elasticsearch.Serverless.Analysis.PatternReplaceCharFilter)value);
				break;
			default:
