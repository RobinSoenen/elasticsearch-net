...
internal sealed partial class PersianAnalyzerConverter : System.Text.Json.Serialization.JsonConverter<PersianAnalyzer>
{
	...
	public override PersianAnalyzer Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, PersianAnalyzer value, System.Text.Json.JsonSerializerOptions options)
	{
...
[JsonConverter(typeof(PersianAnalyzerConverter))]
