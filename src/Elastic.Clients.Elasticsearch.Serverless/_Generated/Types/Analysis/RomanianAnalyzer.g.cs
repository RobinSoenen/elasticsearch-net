...
internal sealed partial class RomanianAnalyzerConverter : System.Text.Json.Serialization.JsonConverter<RomanianAnalyzer>
{
	...
	public override RomanianAnalyzer Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, RomanianAnalyzer value, System.Text.Json.JsonSerializerOptions options)
	{
...
[JsonConverter(typeof(RomanianAnalyzerConverter))]
public sealed partial class RomanianAnalyzer : IAnalyzer
{
...
public sealed partial class RomanianAnalyzerDescriptor : SerializableDescriptor<RomanianAnalyzerDescriptor>, IBuildableDescriptor<RomanianAnalyzer>
{
	internal RomanianAnalyzerDescriptor(Action<RomanianAnalyzerDescriptor> configure) => configure.Invoke(this);

	public RomanianAnalyzerDescriptor() : base()
	{
	}
	...
	public RomanianAnalyzerDescriptor StemExclusion(ICollection<string>? stemExclusion)
	{
		StemExclusionValue = stemExclusion;
		return Self;
	}

	public RomanianAnalyzerDescriptor Stopwords(ICollection<string>? stopwords)
	{
		StopwordsValue = stopwords;
		return Self;
	}

	public RomanianAnalyzerDescriptor StopwordsPath(string? stopwordsPath)
	{
	...
	RomanianAnalyzer IBuildableDescriptor<RomanianAnalyzer>.Build() => new()
	{
