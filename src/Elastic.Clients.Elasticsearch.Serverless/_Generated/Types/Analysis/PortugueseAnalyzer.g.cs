...
internal sealed partial class PortugueseAnalyzerConverter : System.Text.Json.Serialization.JsonConverter<PortugueseAnalyzer>
{
	...
	public override PortugueseAnalyzer Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, PortugueseAnalyzer value, System.Text.Json.JsonSerializerOptions options)
	{
...
[JsonConverter(typeof(PortugueseAnalyzerConverter))]
public sealed partial class PortugueseAnalyzer : IAnalyzer
{
...
public sealed partial class PortugueseAnalyzerDescriptor : SerializableDescriptor<PortugueseAnalyzerDescriptor>, IBuildableDescriptor<PortugueseAnalyzer>
{
	internal PortugueseAnalyzerDescriptor(Action<PortugueseAnalyzerDescriptor> configure) => configure.Invoke(this);

	public PortugueseAnalyzerDescriptor() : base()
	{
	}
	...
	public PortugueseAnalyzerDescriptor StemExclusion(ICollection<string>? stemExclusion)
	{
		StemExclusionValue = stemExclusion;
		return Self;
	}

	public PortugueseAnalyzerDescriptor Stopwords(ICollection<string>? stopwords)
	{
		StopwordsValue = stopwords;
		return Self;
	}

	public PortugueseAnalyzerDescriptor StopwordsPath(string? stopwordsPath)
	{
	...
	PortugueseAnalyzer IBuildableDescriptor<PortugueseAnalyzer>.Build() => new()
	{
