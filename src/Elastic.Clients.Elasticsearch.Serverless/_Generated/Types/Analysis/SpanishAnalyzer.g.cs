...
internal sealed partial class SpanishAnalyzerConverter : System.Text.Json.Serialization.JsonConverter<SpanishAnalyzer>
{
	...
	public override SpanishAnalyzer Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, SpanishAnalyzer value, System.Text.Json.JsonSerializerOptions options)
	{
...
[JsonConverter(typeof(SpanishAnalyzerConverter))]
public sealed partial class SpanishAnalyzer : IAnalyzer
{
	public ICollection<string>? StemExclusion { get; set; }
	public ICollection<string>? Stopwords { get; set; }
	public string? StopwordsPath { get; set; }

	public string Type => "spanish";
}

public sealed partial class SpanishAnalyzerDescriptor : SerializableDescriptor<SpanishAnalyzerDescriptor>, IBuildableDescriptor<SpanishAnalyzer>
{
	internal SpanishAnalyzerDescriptor(Action<SpanishAnalyzerDescriptor> configure) => configure.Invoke(this);

	public SpanishAnalyzerDescriptor() : base()
	{
	}
	...
	public SpanishAnalyzerDescriptor StemExclusion(ICollection<string>? stemExclusion)
	{
		StemExclusionValue = stemExclusion;
		return Self;
	}

	public SpanishAnalyzerDescriptor Stopwords(ICollection<string>? stopwords)
	{
		StopwordsValue = stopwords;
		return Self;
	}

	public SpanishAnalyzerDescriptor StopwordsPath(string? stopwordsPath)
	{
	...
	SpanishAnalyzer IBuildableDescriptor<SpanishAnalyzer>.Build() => new()
	{
