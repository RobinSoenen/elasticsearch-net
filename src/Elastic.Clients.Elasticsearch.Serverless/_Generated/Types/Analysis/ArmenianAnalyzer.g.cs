...
internal sealed partial class ArmenianAnalyzerConverter : System.Text.Json.Serialization.JsonConverter<ArmenianAnalyzer>
{
	...
	public override ArmenianAnalyzer Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, ArmenianAnalyzer value, System.Text.Json.JsonSerializerOptions options)
	{
...
[JsonConverter(typeof(ArmenianAnalyzerConverter))]
public sealed partial class ArmenianAnalyzer : IAnalyzer
{
...
public sealed partial class ArmenianAnalyzerDescriptor : SerializableDescriptor<ArmenianAnalyzerDescriptor>, IBuildableDescriptor<ArmenianAnalyzer>
{
	internal ArmenianAnalyzerDescriptor(Action<ArmenianAnalyzerDescriptor> configure) => configure.Invoke(this);

	public ArmenianAnalyzerDescriptor() : base()
	{
	}
	...
	public ArmenianAnalyzerDescriptor StemExclusion(ICollection<string>? stemExclusion)
	{
		StemExclusionValue = stemExclusion;
		return Self;
	}

	public ArmenianAnalyzerDescriptor Stopwords(ICollection<string>? stopwords)
	{
		StopwordsValue = stopwords;
		return Self;
	}

	public ArmenianAnalyzerDescriptor StopwordsPath(string? stopwordsPath)
	{
	...
	ArmenianAnalyzer IBuildableDescriptor<ArmenianAnalyzer>.Build() => new()
	{
