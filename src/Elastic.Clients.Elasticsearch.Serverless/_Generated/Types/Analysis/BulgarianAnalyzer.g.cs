...
internal sealed partial class BulgarianAnalyzerConverter : System.Text.Json.Serialization.JsonConverter<BulgarianAnalyzer>
{
	...
	public override BulgarianAnalyzer Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, BulgarianAnalyzer value, System.Text.Json.JsonSerializerOptions options)
	{
...
[JsonConverter(typeof(BulgarianAnalyzerConverter))]
public sealed partial class BulgarianAnalyzer : IAnalyzer
{
...
public sealed partial class BulgarianAnalyzerDescriptor : SerializableDescriptor<BulgarianAnalyzerDescriptor>, IBuildableDescriptor<BulgarianAnalyzer>
{
	internal BulgarianAnalyzerDescriptor(Action<BulgarianAnalyzerDescriptor> configure) => configure.Invoke(this);

	public BulgarianAnalyzerDescriptor() : base()
	{
	}
	...
	public BulgarianAnalyzerDescriptor StemExclusion(ICollection<string>? stemExclusion)
	{
		StemExclusionValue = stemExclusion;
		return Self;
	}

	public BulgarianAnalyzerDescriptor Stopwords(ICollection<string>? stopwords)
	{
		StopwordsValue = stopwords;
		return Self;
	}

	public BulgarianAnalyzerDescriptor StopwordsPath(string? stopwordsPath)
	{
	...
	BulgarianAnalyzer IBuildableDescriptor<BulgarianAnalyzer>.Build() => new()
	{
