...
internal sealed partial class NormalizerInterfaceConverter : System.Text.Json.Serialization.JsonConverter<INormalizer>
{
	...
	public override INormalizer Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		{
			"custom" => reader.ReadValue<Elastic.Clients.Elasticsearch.Serverless.Analysis.CustomNormalizer>(options),
			"lowercase" => reader.ReadValue<Elastic.Clients.Elasticsearch.Serverless.Analysis.LowercaseNormalizer>(options),
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, INormalizer value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		{
			case "custom":
				writer.WriteValue(options, (Elastic.Clients.Elasticsearch.Serverless.Analysis.CustomNormalizer)value);
				break;
			case "lowercase":
				writer.WriteValue(options, (Elastic.Clients.Elasticsearch.Serverless.Analysis.LowercaseNormalizer)value);
				break;
			default:
