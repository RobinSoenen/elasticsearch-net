...
internal sealed partial class HindiAnalyzerConverter : System.Text.Json.Serialization.JsonConverter<HindiAnalyzer>
{
	...
	public override HindiAnalyzer Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, HindiAnalyzer value, System.Text.Json.JsonSerializerOptions options)
	{
...
[JsonConverter(typeof(HindiAnalyzerConverter))]
public sealed partial class HindiAnalyzer : IAnalyzer
{
...
public sealed partial class HindiAnalyzerDescriptor : SerializableDescriptor<HindiAnalyzerDescriptor>, IBuildableDescriptor<HindiAnalyzer>
{
	internal HindiAnalyzerDescriptor(Action<HindiAnalyzerDescriptor> configure) => configure.Invoke(this);

	public HindiAnalyzerDescriptor() : base()
	{
	}
	...
	public HindiAnalyzerDescriptor StemExclusion(ICollection<string>? stemExclusion)
	{
		StemExclusionValue = stemExclusion;
		return Self;
	}

	public HindiAnalyzerDescriptor Stopwords(ICollection<string>? stopwords)
	{
		StopwordsValue = stopwords;
		return Self;
	}

	public HindiAnalyzerDescriptor StopwordsPath(string? stopwordsPath)
	{
	...
	HindiAnalyzer IBuildableDescriptor<HindiAnalyzer>.Build() => new()
	{
