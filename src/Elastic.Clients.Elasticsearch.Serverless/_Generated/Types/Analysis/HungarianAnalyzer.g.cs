...
internal sealed partial class HungarianAnalyzerConverter : System.Text.Json.Serialization.JsonConverter<HungarianAnalyzer>
{
	...
	public override HungarianAnalyzer Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		reader.ValidateToken(System.Text.Json.JsonTokenType.StartObject);
		LocalJsonProperty<ICollection<string>?> propStemExclusion = default;
		LocalJsonProperty<ICollection<string>?> propStopwords = default;
		LocalJsonProperty<string?> propStopwordsPath = default;
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, HungarianAnalyzer value, System.Text.Json.JsonSerializerOptions options)
	{
...
[JsonConverter(typeof(HungarianAnalyzerConverter))]
public sealed partial class HungarianAnalyzer : IAnalyzer
{
	public ICollection<string>? StemExclusion { get; set; }
	public ICollection<string>? Stopwords { get; set; }
	public string? StopwordsPath { get; set; }

	public string Type => "hungarian";
}

public sealed partial class HungarianAnalyzerDescriptor : SerializableDescriptor<HungarianAnalyzerDescriptor>, IBuildableDescriptor<HungarianAnalyzer>
{
	internal HungarianAnalyzerDescriptor(Action<HungarianAnalyzerDescriptor> configure) => configure.Invoke(this);

	public HungarianAnalyzerDescriptor() : base()
	{
	}
	...
	public HungarianAnalyzerDescriptor StemExclusion(ICollection<string>? stemExclusion)
	{
		StemExclusionValue = stemExclusion;
		return Self;
	}

	public HungarianAnalyzerDescriptor Stopwords(ICollection<string>? stopwords)
	{
		StopwordsValue = stopwords;
		return Self;
	}

	public HungarianAnalyzerDescriptor StopwordsPath(string? stopwordsPath)
	{
	...
	HungarianAnalyzer IBuildableDescriptor<HungarianAnalyzer>.Build() => new()
	{
