...
internal sealed partial class DanishAnalyzerConverter : System.Text.Json.Serialization.JsonConverter<DanishAnalyzer>
{
	...
	public override DanishAnalyzer Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, DanishAnalyzer value, System.Text.Json.JsonSerializerOptions options)
	{
...
[JsonConverter(typeof(DanishAnalyzerConverter))]
...
public sealed partial class DanishAnalyzerDescriptor : SerializableDescriptor<DanishAnalyzerDescriptor>, IBuildableDescriptor<DanishAnalyzer>
{
	...
	public DanishAnalyzerDescriptor Stopwords(ICollection<string>? stopwords)
	{
