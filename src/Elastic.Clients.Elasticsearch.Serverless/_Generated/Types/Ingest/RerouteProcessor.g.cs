...
internal sealed partial class RerouteProcessorConverter : System.Text.Json.Serialization.JsonConverter<RerouteProcessor>
{
	...
	public override RerouteProcessor Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<ICollection<string>?> propDataset = default;
		LocalJsonProperty<string?> propDescription = default;
		LocalJsonProperty<string?> propDestination = default;
		LocalJsonProperty<string?> propIf = default;
		LocalJsonProperty<bool?> propIgnoreFailure = default;
		LocalJsonProperty<ICollection<string>?> propNamespace = default;
		...
		{
			if (propDataset.TryRead(ref reader, options, PropDataset, typeof(SingleOrManyMarker<IReadOnlyCollection<string>?, string>)))
			{
				continue;
			}
			...
			if (propNamespace.TryRead(ref reader, options, PropNamespace, typeof(SingleOrManyMarker<IReadOnlyCollection<string>?, string>)))
			{
				continue;
			}
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, RerouteProcessor value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		writer.WriteProperty(options, PropDataset, value.Dataset, typeof(SingleOrManyMarker<IReadOnlyCollection<string>?, string>));
		...
		writer.WriteProperty(options, PropNamespace, value.Namespace, typeof(SingleOrManyMarker<IReadOnlyCollection<string>?, string>));
...
public sealed partial class RerouteProcessor
{
	...
	public static implicit operator Elastic.Clients.Elasticsearch.Serverless.Ingest.Processor(RerouteProcessor rerouteProcessor) => Elastic.Clients.Elasticsearch.Serverless.Ingest.Processor.Reroute(rerouteProcessor);
}
...
public sealed partial class RerouteProcessorDescriptor<TDocument> : SerializableDescriptor<RerouteProcessorDescriptor<TDocument>>
{
	...
	public RerouteProcessorDescriptor<TDocument> OnFailure(Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor<TDocument> descriptor)
	{
		OnFailureValue = null;
		OnFailureDescriptorAction = null;
		OnFailureDescriptorActions = null;
	...
	public RerouteProcessorDescriptor<TDocument> OnFailure(Action<Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor<TDocument>> configure)
	{
		OnFailureValue = null;
		OnFailureDescriptor = null;
		OnFailureDescriptorActions = null;
	...
	public RerouteProcessorDescriptor<TDocument> OnFailure(params Action<Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor<TDocument>>[] configure)
	{
		OnFailureValue = null;
		OnFailureDescriptor = null;
		OnFailureDescriptorAction = null;
...
public sealed partial class RerouteProcessorDescriptor : SerializableDescriptor<RerouteProcessorDescriptor>
{
	...
	public RerouteProcessorDescriptor OnFailure(Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor descriptor)
	{
		OnFailureValue = null;
		OnFailureDescriptorAction = null;
		OnFailureDescriptorActions = null;
	...
	public RerouteProcessorDescriptor OnFailure(Action<Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor> configure)
	{
		OnFailureValue = null;
		OnFailureDescriptor = null;
		OnFailureDescriptorActions = null;
	...
	public RerouteProcessorDescriptor OnFailure(params Action<Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor>[] configure)
	{
		OnFailureValue = null;
		OnFailureDescriptor = null;
		OnFailureDescriptorAction = null;
