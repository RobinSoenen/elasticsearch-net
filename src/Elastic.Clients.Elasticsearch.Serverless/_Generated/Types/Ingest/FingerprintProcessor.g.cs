...
internal sealed partial class FingerprintProcessorConverter : System.Text.Json.Serialization.JsonConverter<FingerprintProcessor>
{
	...
	public override FingerprintProcessor Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<string?> propIf = default;
		LocalJsonProperty<bool?> propIgnoreFailure = default;
		LocalJsonProperty<bool?> propIgnoreMissing = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Ingest.FingerprintDigest?> propMethod = default;
		LocalJsonProperty<ICollection<Elastic.Clients.Elasticsearch.Serverless.Ingest.Processor>?> propOnFailure = default;
		LocalJsonProperty<string?> propSalt = default;
		LocalJsonProperty<string?> propTag = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Field?> propTargetField = default;
...
public sealed partial class FingerprintProcessorDescriptor<TDocument> : SerializableDescriptor<FingerprintProcessorDescriptor<TDocument>>
{
	...
	/// </para>
	/// </summary>
	public FingerprintProcessorDescriptor<TDocument> Fields(Elastic.Clients.Elasticsearch.Serverless.Fields fields)
	{
		FieldsValue = fields;
		return Self;
	}
	...
	/// </para>
	/// </summary>
	public FingerprintProcessorDescriptor<TDocument> Method(Elastic.Clients.Elasticsearch.Serverless.Ingest.FingerprintDigest? method)
	{
		MethodValue = method;
		return Self;
	}
	...
	/// </para>
	/// </summary>
	public FingerprintProcessorDescriptor<TDocument> OnFailure(ICollection<Elastic.Clients.Elasticsearch.Serverless.Ingest.Processor>? onFailure)
	{
	...
	public FingerprintProcessorDescriptor<TDocument> OnFailure(Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor<TDocument> descriptor)
	{
		OnFailureValue = null;
		OnFailureDescriptorAction = null;
		OnFailureDescriptorActions = null;
	...
	public FingerprintProcessorDescriptor<TDocument> OnFailure(Action<Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor<TDocument>> configure)
	{
		OnFailureValue = null;
		OnFailureDescriptor = null;
		OnFailureDescriptorActions = null;
	...
	public FingerprintProcessorDescriptor<TDocument> OnFailure(params Action<Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor<TDocument>>[] configure)
	{
		OnFailureValue = null;
		OnFailureDescriptor = null;
		OnFailureDescriptorAction = null;
	...
	/// </para>
	/// </summary>
	public FingerprintProcessorDescriptor<TDocument> TargetField(Elastic.Clients.Elasticsearch.Serverless.Field? targetField)
	{
...
public sealed partial class FingerprintProcessorDescriptor : SerializableDescriptor<FingerprintProcessorDescriptor>
{
	...
	/// </para>
	/// </summary>
	public FingerprintProcessorDescriptor OnFailure(ICollection<Elastic.Clients.Elasticsearch.Serverless.Ingest.Processor>? onFailure)
	{
		OnFailureDescriptor = null;
		OnFailureDescriptorAction = null;
		OnFailureDescriptorActions = null;
	...
	public FingerprintProcessorDescriptor OnFailure(Action<Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor> configure)
	{
		OnFailureValue = null;
		OnFailureDescriptor = null;
		OnFailureDescriptorActions = null;
	...
	public FingerprintProcessorDescriptor OnFailure(params Action<Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor>[] configure)
	{
		OnFailureValue = null;
		OnFailureDescriptor = null;
		OnFailureDescriptorAction = null;
	...
	/// </para>
	/// </summary>
	public FingerprintProcessorDescriptor TargetField(Elastic.Clients.Elasticsearch.Serverless.Field? targetField)
	{
		TargetFieldValue = targetField;
		return Self;
	}
