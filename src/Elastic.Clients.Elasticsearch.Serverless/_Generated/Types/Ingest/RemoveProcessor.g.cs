...
internal sealed partial class RemoveProcessorConverter : System.Text.Json.Serialization.JsonConverter<RemoveProcessor>
{
	...
	public override RemoveProcessor Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Fields> propField = default;
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Fields?> propKeep = default;
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, RemoveProcessor value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		writer.WriteProperty(options, PropKeep, value.Keep, typeof(SingleOrManyFieldsMarker));
...
public sealed partial class RemoveProcessor
{
	...
	public static implicit operator Elastic.Clients.Elasticsearch.Serverless.Ingest.Processor(RemoveProcessor removeProcessor) => Elastic.Clients.Elasticsearch.Serverless.Ingest.Processor.Remove(removeProcessor);
}
...
public sealed partial class RemoveProcessorDescriptor<TDocument> : SerializableDescriptor<RemoveProcessorDescriptor<TDocument>>
{
	...
	/// </para>
	/// </summary>
	public RemoveProcessorDescriptor<TDocument> Field(Elastic.Clients.Elasticsearch.Serverless.Fields field)
	{
		FieldValue = field;
		return Self;
	}
	...
	/// </para>
	/// </summary>
	public RemoveProcessorDescriptor<TDocument> OnFailure(ICollection<Elastic.Clients.Elasticsearch.Serverless.Ingest.Processor>? onFailure)
	{
	...
	public RemoveProcessorDescriptor<TDocument> OnFailure(Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor<TDocument> descriptor)
	{
		OnFailureValue = null;
		OnFailureDescriptorAction = null;
		OnFailureDescriptorActions = null;
	...
	public RemoveProcessorDescriptor<TDocument> OnFailure(Action<Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor<TDocument>> configure)
	{
		OnFailureValue = null;
		OnFailureDescriptor = null;
		OnFailureDescriptorActions = null;
	...
	public RemoveProcessorDescriptor<TDocument> OnFailure(params Action<Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor<TDocument>>[] configure)
	{
		OnFailureValue = null;
		OnFailureDescriptor = null;
		OnFailureDescriptorAction = null;
...
public sealed partial class RemoveProcessorDescriptor : SerializableDescriptor<RemoveProcessorDescriptor>
{
	...
	/// </para>
	/// </summary>
	public RemoveProcessorDescriptor Field(Elastic.Clients.Elasticsearch.Serverless.Fields field)
	{
		FieldValue = field;
		return Self;
	}
	...
	/// </para>
	/// </summary>
	public RemoveProcessorDescriptor OnFailure(ICollection<Elastic.Clients.Elasticsearch.Serverless.Ingest.Processor>? onFailure)
	{
		OnFailureDescriptor = null;
		OnFailureDescriptorAction = null;
		OnFailureDescriptorActions = null;
	...
	public RemoveProcessorDescriptor OnFailure(Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor descriptor)
	{
		OnFailureValue = null;
		OnFailureDescriptorAction = null;
		OnFailureDescriptorActions = null;
	...
	public RemoveProcessorDescriptor OnFailure(Action<Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor> configure)
	{
		OnFailureValue = null;
		OnFailureDescriptor = null;
		OnFailureDescriptorActions = null;
	...
	public RemoveProcessorDescriptor OnFailure(params Action<Elastic.Clients.Elasticsearch.Serverless.Ingest.ProcessorDescriptor>[] configure)
	{
		OnFailureValue = null;
		OnFailureDescriptor = null;
		OnFailureDescriptorAction = null;
