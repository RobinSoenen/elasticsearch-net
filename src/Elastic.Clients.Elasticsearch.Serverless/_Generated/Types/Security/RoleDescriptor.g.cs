...
internal sealed partial class RoleDescriptorConverter : System.Text.Json.Serialization.JsonConverter<RoleDescriptor>
{
	...
	public override RoleDescriptor Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<ICollection<Elastic.Clients.Elasticsearch.Serverless.Security.ApplicationPrivileges>?> propApplications = default;
		LocalJsonProperty<ICollection<Elastic.Clients.Elasticsearch.Serverless.Security.ClusterPrivilege>?> propCluster = default;
		LocalJsonProperty<string?> propDescription = default;
		LocalJsonProperty<ICollection<Elastic.Clients.Elasticsearch.Serverless.Security.IndicesPrivileges>?> propIndices = default;
		...
		LocalJsonProperty<ICollection<string>?> propRunAs = default;
		LocalJsonProperty<IDictionary<string, object>?> propTransientMetadata = default;
