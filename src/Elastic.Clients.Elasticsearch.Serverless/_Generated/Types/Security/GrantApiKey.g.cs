...
internal sealed partial class GrantApiKeyConverter : System.Text.Json.Serialization.JsonConverter<GrantApiKey>
{
	...
	public override GrantApiKey Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<string?> propExpiration = default;
		...
		LocalJsonProperty<ICollection<IDictionary<string, Elastic.Clients.Elasticsearch.Serverless.Security.RoleDescriptor>>?> propRoleDescriptors = default;
		while (reader.Read() && reader.TokenType is System.Text.Json.JsonTokenType.PropertyName)
		{
			...
			if (propRoleDescriptors.TryRead(ref reader, options, PropRoleDescriptors, typeof(SingleOrManyMarker<IReadOnlyCollection<IReadOnlyDictionary<string, Elastic.Clients.Elasticsearch.Serverless.Security.RoleDescriptor>>?, IReadOnlyDictionary<string, Elastic.Clients.Elasticsearch.Serverless.Security.RoleDescriptor>>)))
			{
				continue;
			}
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, GrantApiKey value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		writer.WriteProperty(options, PropRoleDescriptors, value.RoleDescriptors, typeof(SingleOrManyMarker<IReadOnlyCollection<IReadOnlyDictionary<string, Elastic.Clients.Elasticsearch.Serverless.Security.RoleDescriptor>>?, IReadOnlyDictionary<string, Elastic.Clients.Elasticsearch.Serverless.Security.RoleDescriptor>>));
...
public sealed partial class GrantApiKey
{
	...
	/// </para>
	/// </summary>
	public ICollection<IDictionary<string, Elastic.Clients.Elasticsearch.Serverless.Security.RoleDescriptor>>? RoleDescriptors { get; set; }
}
...
public sealed partial class GrantApiKeyDescriptor<TDocument> : SerializableDescriptor<GrantApiKeyDescriptor<TDocument>>
{
	...
	private ICollection<IDictionary<string, Elastic.Clients.Elasticsearch.Serverless.Security.RoleDescriptor>>? RoleDescriptorsValue { get; set; }
	...
	public GrantApiKeyDescriptor<TDocument> Name(Elastic.Clients.Elasticsearch.Serverless.Name name)
	{
		NameValue = name;
		return Self;
	}
	...
	/// </para>
	/// </summary>
	public GrantApiKeyDescriptor<TDocument> RoleDescriptors(ICollection<IDictionary<string, Elastic.Clients.Elasticsearch.Serverless.Security.RoleDescriptor>>? roleDescriptors)
	{
	...
	protected override void Serialize(Utf8JsonWriter writer, JsonSerializerOptions options, IElasticsearchClientSettings settings)
	{
		...
		if (RoleDescriptorsValue is not null)
		{
			...
			SingleOrManySerializationHelper.Serialize<IDictionary<string, Elastic.Clients.Elasticsearch.Serverless.Security.RoleDescriptor>>(RoleDescriptorsValue, writer, options);
		}
...
public sealed partial class GrantApiKeyDescriptor : SerializableDescriptor<GrantApiKeyDescriptor>
{
	...
	public GrantApiKeyDescriptor Name(Elastic.Clients.Elasticsearch.Serverless.Name name)
	{
		NameValue = name;
		return Self;
	}
	...
	/// </para>
	/// </summary>
	public GrantApiKeyDescriptor RoleDescriptors(ICollection<IDictionary<string, Elastic.Clients.Elasticsearch.Serverless.Security.RoleDescriptor>>? roleDescriptors)
	{
		RoleDescriptorsValue = roleDescriptors;
		return Self;
	}
