...
internal sealed partial class IndicesPrivilegesConverter : System.Text.Json.Serialization.JsonConverter<IndicesPrivileges>
{
	...
	public override IndicesPrivileges Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<ICollection<Elastic.Clients.Elasticsearch.Serverless.IndexName>> propNames = default;
		LocalJsonProperty<ICollection<Elastic.Clients.Elasticsearch.Serverless.Security.IndexPrivilege>> propPrivileges = default;
		...
		while (reader.Read() && reader.TokenType is System.Text.Json.JsonTokenType.PropertyName)
		{
			...
			if (propNames.TryRead(ref reader, options, PropNames, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.IndexName>, Elastic.Clients.Elasticsearch.Serverless.IndexName>)))
			{
				continue;
			}
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, IndicesPrivileges value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		writer.WriteProperty(options, PropNames, value.Names, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.IndexName>, Elastic.Clients.Elasticsearch.Serverless.IndexName>));
...
public sealed partial class IndicesPrivilegesDescriptor<TDocument> : SerializableDescriptor<IndicesPrivilegesDescriptor<TDocument>>
{
	...
	protected override void Serialize(Utf8JsonWriter writer, JsonSerializerOptions options, IElasticsearchClientSettings settings)
	{
		...
		SingleOrManySerializationHelper.Serialize<Elastic.Clients.Elasticsearch.Serverless.IndexName>(NamesValue, writer, options);
