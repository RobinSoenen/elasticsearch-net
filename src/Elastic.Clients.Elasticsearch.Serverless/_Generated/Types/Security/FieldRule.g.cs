...
public sealed partial class FieldRule
{
	...
	public static FieldRule Dn(Elastic.Clients.Elasticsearch.Serverless.Names names) => new FieldRule("dn", names);
	public static FieldRule Groups(Elastic.Clients.Elasticsearch.Serverless.Names names) => new FieldRule("groups", names);
	public static FieldRule Username(Elastic.Clients.Elasticsearch.Serverless.Names names) => new FieldRule("username", names);
	...
	public override FieldRule Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		while (reader.Read() && reader.TokenType is System.Text.Json.JsonTokenType.PropertyName)
		{
			if (reader.ValueTextEquals(VariantDn))
			{
				...
				reader.Read();
				variant = reader.ReadValue<Elastic.Clients.Elasticsearch.Serverless.Names?>(options);
				continue;
			}
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, FieldRule value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		switch (value.VariantType)
		{
			case "":
				break;
			case "dn":
				writer.WriteProperty(options, value.VariantType, (Elastic.Clients.Elasticsearch.Serverless.Names?)value.Variant);
				break;
			case "groups":
				writer.WriteProperty(options, value.VariantType, (Elastic.Clients.Elasticsearch.Serverless.Names?)value.Variant);
				break;
...
public sealed partial class FieldRuleDescriptor<TDocument> : SerializableDescriptor<FieldRuleDescriptor<TDocument>>
{
	...
	public FieldRuleDescriptor<TDocument> Dn(Elastic.Clients.Elasticsearch.Serverless.Names names) => Set(names, "dn");
	public FieldRuleDescriptor<TDocument> Groups(Elastic.Clients.Elasticsearch.Serverless.Names names) => Set(names, "groups");
	public FieldRuleDescriptor<TDocument> Username(Elastic.Clients.Elasticsearch.Serverless.Names names) => Set(names, "username");
...
public sealed partial class FieldRuleDescriptor : SerializableDescriptor<FieldRuleDescriptor>
{
	...
	public FieldRuleDescriptor Dn(Elastic.Clients.Elasticsearch.Serverless.Names names) => Set(names, "dn");
	public FieldRuleDescriptor Groups(Elastic.Clients.Elasticsearch.Serverless.Names names) => Set(names, "groups");
	public FieldRuleDescriptor Username(Elastic.Clients.Elasticsearch.Serverless.Names names) => Set(names, "username");
