...
internal sealed partial class UserIndicesPrivilegesConverter : System.Text.Json.Serialization.JsonConverter<UserIndicesPrivileges>
{
	...
	public override UserIndicesPrivileges Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.Security.FieldSecurity>?> propFieldSecurity = default;
		LocalJsonProperty<IReadOnlyCollection<string>> propNames = default;
		LocalJsonProperty<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.Security.IndexPrivilege>> propPrivileges = default;
