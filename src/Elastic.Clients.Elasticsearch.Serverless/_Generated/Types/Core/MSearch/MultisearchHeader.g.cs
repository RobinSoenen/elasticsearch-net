...
internal sealed partial class MultisearchHeaderConverter : System.Text.Json.Serialization.JsonConverter<MultisearchHeader>
{
	...
	public override MultisearchHeader Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<bool?> propAllowNoIndices = default;
		LocalJsonProperty<bool?> propAllowPartialSearchResults = default;
		LocalJsonProperty<bool?> propCcsMinimizeRoundtrips = default;
		LocalJsonProperty<ICollection<Elastic.Clients.Elasticsearch.Serverless.ExpandWildcard>?> propExpandWildcards = default;
		LocalJsonProperty<bool?> propIgnoreThrottled = default;
		...
		LocalJsonProperty<string?> propPreference = default;
		LocalJsonProperty<bool?> propRequestCache = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Routing?> propRouting = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.SearchType?> propSearchType = default;
		while (reader.Read() && reader.TokenType is System.Text.Json.JsonTokenType.PropertyName)
		{
			...
			if (propExpandWildcards.TryRead(ref reader, options, PropExpandWildcards, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.ExpandWildcard>?, Elastic.Clients.Elasticsearch.Serverless.ExpandWildcard>)))
			{
				continue;
			}
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, MultisearchHeader value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		writer.WriteProperty(options, PropExpandWildcards, value.ExpandWildcards, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.ExpandWildcard>?, Elastic.Clients.Elasticsearch.Serverless.ExpandWildcard>));
...
public sealed partial class MultisearchHeaderDescriptor : SerializableDescriptor<MultisearchHeaderDescriptor>
{
	...
	public MultisearchHeaderDescriptor Indices(Elastic.Clients.Elasticsearch.Serverless.Indices? indices)
	{
