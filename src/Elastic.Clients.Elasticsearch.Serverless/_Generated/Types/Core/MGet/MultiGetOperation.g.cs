...
internal sealed partial class MultiGetOperationConverter : System.Text.Json.Serialization.JsonConverter<MultiGetOperation>
{
	...
	public override MultiGetOperation Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Id> propId = default;
...
public sealed partial class MultiGetOperationDescriptor<TDocument> : SerializableDescriptor<MultiGetOperationDescriptor<TDocument>>
{
	...
	/// </para>
	/// </summary>
	public MultiGetOperationDescriptor<TDocument> Id(Elastic.Clients.Elasticsearch.Serverless.Id id)
	{
		IdValue = id;
		return Self;
	}
	...
	/// </para>
	/// </summary>
	public MultiGetOperationDescriptor<TDocument> Index(Elastic.Clients.Elasticsearch.Serverless.IndexName? index)
	{
		IndexValue = index;
		return Self;
	}
	...
	/// </para>
	/// </summary>
	public MultiGetOperationDescriptor<TDocument> Routing(Elastic.Clients.Elasticsearch.Serverless.Routing? routing)
	{
	...
	/// </para>
	/// </summary>
	public MultiGetOperationDescriptor<TDocument> Source(Elastic.Clients.Elasticsearch.Serverless.Core.Search.SourceConfig? source)
	{
		SourceValue = source;
		return Self;
	}
	...
	/// </para>
	/// </summary>
	public MultiGetOperationDescriptor<TDocument> StoredFields(Elastic.Clients.Elasticsearch.Serverless.Fields? storedFields)
	{
	...
	public MultiGetOperationDescriptor<TDocument> VersionType(Elastic.Clients.Elasticsearch.Serverless.VersionType? versionType)
	{
