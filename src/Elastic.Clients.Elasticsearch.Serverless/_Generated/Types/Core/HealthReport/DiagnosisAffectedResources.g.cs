...
internal sealed partial class DiagnosisAffectedResourcesConverter : System.Text.Json.Serialization.JsonConverter<DiagnosisAffectedResources>
{
	...
	public override DiagnosisAffectedResources Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<IReadOnlyCollection<string>?> propFeatureStates = default;
		LocalJsonProperty<IReadOnlyCollection<string>?> propIndices = default;
		LocalJsonProperty<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.Core.HealthReport.IndicatorNode>?> propNodes = default;
		LocalJsonProperty<IReadOnlyCollection<string>?> propSlmPolicies = default;
		LocalJsonProperty<IReadOnlyCollection<string>?> propSnapshotRepositories = default;
...
public sealed partial class DiagnosisAffectedResources
{
	...
	public IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.Core.HealthReport.IndicatorNode>? Nodes { get; init; }
