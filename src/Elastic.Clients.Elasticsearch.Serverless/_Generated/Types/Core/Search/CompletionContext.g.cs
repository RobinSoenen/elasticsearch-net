...
internal sealed partial class CompletionContextConverter : System.Text.Json.Serialization.JsonConverter<CompletionContext>
{
	...
	public override CompletionContext Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Core.Search.Context> propContext = default;
		LocalJsonProperty<ICollection<Elastic.Clients.Elasticsearch.Serverless.GeohashPrecision>?> propNeighbours = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.GeohashPrecision?> propPrecision = default;
		LocalJsonProperty<bool?> propPrefix = default;
		while (reader.Read() && reader.TokenType is System.Text.Json.JsonTokenType.PropertyName)
		{
			...
			try
			{
				...
				var result = reader.ReadValue<Elastic.Clients.Elasticsearch.Serverless.Core.Search.Context>(options);
...
public sealed partial class CompletionContext
{
	...
	/// </para>
	/// </summary>
	public Elastic.Clients.Elasticsearch.Serverless.Core.Search.Context Context { get; set; }
	...
	/// </para>
	/// </summary>
	public ICollection<Elastic.Clients.Elasticsearch.Serverless.GeohashPrecision>? Neighbours { get; set; }
...
public sealed partial class CompletionContextDescriptor : SerializableDescriptor<CompletionContextDescriptor>
{
	...
	private Elastic.Clients.Elasticsearch.Serverless.Core.Search.Context ContextValue { get; set; }
	private ICollection<Elastic.Clients.Elasticsearch.Serverless.GeohashPrecision>? NeighboursValue { get; set; }
	private Elastic.Clients.Elasticsearch.Serverless.GeohashPrecision? PrecisionValue { get; set; }
	...
	/// </para>
	/// </summary>
	public CompletionContextDescriptor Context(Elastic.Clients.Elasticsearch.Serverless.Core.Search.Context context)
	{
	...
	/// </para>
	/// </summary>
	public CompletionContextDescriptor Neighbours(ICollection<Elastic.Clients.Elasticsearch.Serverless.GeohashPrecision>? neighbours)
	{
	...
	/// </para>
	/// </summary>
	public CompletionContextDescriptor Precision(Elastic.Clients.Elasticsearch.Serverless.GeohashPrecision? precision)
	{
