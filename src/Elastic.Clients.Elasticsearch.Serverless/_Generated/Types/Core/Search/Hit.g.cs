...
internal sealed partial class HitConverter<TDocument> : System.Text.Json.Serialization.JsonConverter<Hit<TDocument>>
{
	...
	public override Hit<TDocument> Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Core.Explain.Explanation?> propExplanation = default;
		LocalJsonProperty<IReadOnlyDictionary<string, object>?> propFields = default;
		LocalJsonProperty<IReadOnlyDictionary<string, IReadOnlyCollection<string>>?> propHighlight = default;
		LocalJsonProperty<string?> propId = default;
		LocalJsonProperty<IReadOnlyCollection<string>?> propIgnored = default;
		LocalJsonProperty<IReadOnlyDictionary<string, IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.FieldValue>>?> propIgnoredFieldValues = default;
		LocalJsonProperty<string> propIndex = default;
		LocalJsonProperty<IReadOnlyDictionary<string, Elastic.Clients.Elasticsearch.Serverless.Core.Search.InnerHitsResult>?> propInnerHits = default;
		LocalJsonProperty<IReadOnlyCollection<string>?> propMatchedQueries = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Core.Search.NestedIdentity?> propNested = default;
		LocalJsonProperty<string?> propNode = default;
		LocalJsonProperty<long?> propPrimaryTerm = default;
		LocalJsonProperty<int?> propRank = default;
		LocalJsonProperty<string?> propRouting = default;
		LocalJsonProperty<double?> propScore = default;
		LocalJsonProperty<long?> propSeqNo = default;
		LocalJsonProperty<string?> propShard = default;
		LocalJsonProperty<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.FieldValue>?> propSort = default;
		LocalJsonProperty<TDocument?> propSource = default;
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, Hit<TDocument> value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		writer.WriteProperty(options, PropSource, value.Source, typeof(SourceMarker<TDocument?>));
...
{
	public Elastic.Clients.Elasticsearch.Serverless.Core.Explain.Explanation? Explanation { get; init; }
	...
	public IReadOnlyDictionary<string, Elastic.Clients.Elasticsearch.Serverless.Core.Search.InnerHitsResult>? InnerHits { get; init; }
