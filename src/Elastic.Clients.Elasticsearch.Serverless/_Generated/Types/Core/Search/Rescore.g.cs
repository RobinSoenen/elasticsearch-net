...
internal sealed partial class RescoreConverter : System.Text.Json.Serialization.JsonConverter<Rescore>
{
	...
	public override Rescore Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<int?> propWindowSize = default;
		...
		while (reader.Read() && reader.TokenType is System.Text.Json.JsonTokenType.PropertyName)
		{
			...
			if (reader.ValueTextEquals(VariantLearningToRank))
			{
				...
				reader.Read();
				variant = reader.ReadValue<Elastic.Clients.Elasticsearch.Serverless.Core.Search.LearningToRank?>(options);
				continue;
			}
			...
			if (reader.ValueTextEquals(VariantQuery))
			{
				...
				reader.Read();
				variant = reader.ReadValue<Elastic.Clients.Elasticsearch.Serverless.Core.Search.RescoreQuery?>(options);
				continue;
			}
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, Rescore value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		switch (value.VariantType)
		{
			...
			case "learning_to_rank":
				writer.WriteProperty(options, value.VariantType, (Elastic.Clients.Elasticsearch.Serverless.Core.Search.LearningToRank?)value.Variant);
				break;
			case "query":
				writer.WriteProperty(options, value.VariantType, (Elastic.Clients.Elasticsearch.Serverless.Core.Search.RescoreQuery?)value.Variant);
				break;
			default:
