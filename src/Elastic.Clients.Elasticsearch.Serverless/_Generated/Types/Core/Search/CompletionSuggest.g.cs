...
internal sealed partial class CompletionSuggestConverter<TDocument> : System.Text.Json.Serialization.JsonConverter<CompletionSuggest<TDocument>>
{
	...
	public override CompletionSuggest<TDocument> Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.Core.Search.CompletionSuggestOption<TDocument>>> propOptions = default;
		...
		while (reader.Read() && reader.TokenType is System.Text.Json.JsonTokenType.PropertyName)
		{
			...
			if (propOptions.TryRead(ref reader, options, PropOptions, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.Core.Search.CompletionSuggestOption<TDocument>>, Elastic.Clients.Elasticsearch.Serverless.Core.Search.CompletionSuggestOption<TDocument>>)))
			{
				continue;
			}
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, CompletionSuggest<TDocument> value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		writer.WriteProperty(options, PropOptions, value.Options, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.Core.Search.CompletionSuggestOption<TDocument>>, Elastic.Clients.Elasticsearch.Serverless.Core.Search.CompletionSuggestOption<TDocument>>));
