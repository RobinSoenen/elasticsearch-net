...
internal sealed partial class SuggestDictionaryConverter<TDocument> : System.Text.Json.Serialization.JsonConverter<SuggestDictionary<TDocument>>
{
	...
	internal static void ReadItem(ref System.Text.Json.Utf8JsonReader reader, System.Text.Json.JsonSerializerOptions options, out string name, out IReadOnlyCollection<ISuggest> value)
	{
		...
		{
			"completion" => reader.ReadValue<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.Core.Search.CompletionSuggest<TDocument>>>(options),
			"phrase" => reader.ReadValue<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.Core.Search.PhraseSuggest>>(options),
			"term" => reader.ReadValue<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.Core.Search.TermSuggest>>(options),
	...
	internal static void WriteItem(System.Text.Json.Utf8JsonWriter writer, System.Text.Json.JsonSerializerOptions options, string name, IReadOnlyCollection<ISuggest> value)
	{
		...
		switch (value)
		{
			case IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.Core.Search.CompletionSuggest<TDocument>> v:
				writer.WriteProperty(options, key, v);
				break;
			case IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.Core.Search.PhraseSuggest> v:
				writer.WriteProperty(options, key, v);
				break;
			case IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.Core.Search.TermSuggest> v:
				writer.WriteProperty(options, key, v);
				break;
			default:
