...
internal sealed partial class HighlightFieldConverter : System.Text.Json.Serialization.JsonConverter<HighlightField>
{
	...
	public override HighlightField Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<string?> propBoundaryChars = default;
		LocalJsonProperty<int?> propBoundaryMaxScan = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Core.Search.BoundaryScanner?> propBoundaryScanner = default;
		LocalJsonProperty<string?> propBoundaryScannerLocale = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Core.Search.HighlighterFragmenter?> propFragmenter = default;
		LocalJsonProperty<int?> propFragmentOffset = default;
		LocalJsonProperty<int?> propFragmentSize = default;
		LocalJsonProperty<bool?> propHighlightFilter = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.QueryDsl.Query?> propHighlightQuery = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Fields?> propMatchedFields = default;
		LocalJsonProperty<int?> propMaxAnalyzedOffset = default;
		LocalJsonProperty<int?> propMaxFragmentLength = default;
		LocalJsonProperty<int?> propNoMatchSize = default;
		LocalJsonProperty<int?> propNumberOfFragments = default;
		LocalJsonProperty<IDictionary<string, object>?> propOptions = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Core.Search.HighlighterOrder?> propOrder = default;
		LocalJsonProperty<int?> propPhraseLimit = default;
		LocalJsonProperty<ICollection<string>?> propPostTags = default;
		LocalJsonProperty<ICollection<string>?> propPreTags = default;
		LocalJsonProperty<bool?> propRequireFieldMatch = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Core.Search.HighlighterTagsSchema?> propTagsSchema = default;
		LocalJsonProperty<Elastic.Clients.Elasticsearch.Serverless.Core.Search.HighlighterType?> propType = default;
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, HighlightField value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		writer.WriteProperty(options, PropMatchedFields, value.MatchedFields, typeof(SingleOrManyFieldsMarker));
