	...
	public override SmoothingModel Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		while (reader.Read() && reader.TokenType is System.Text.Json.JsonTokenType.PropertyName)
		{
			if (reader.ValueTextEquals(VariantLaplace))
			{
				...
				reader.Read();
				variant = reader.ReadValue<Elastic.Clients.Elasticsearch.Serverless.Core.Search.LaplaceSmoothingModel?>(options);
				continue;
			}
			...
			if (reader.ValueTextEquals(VariantLinearInterpolation))
			{
				...
				reader.Read();
				variant = reader.ReadValue<Elastic.Clients.Elasticsearch.Serverless.Core.Search.LinearInterpolationSmoothingModel?>(options);
				continue;
			}
			...
			if (reader.ValueTextEquals(VariantStupidBackoff))
			{
				...
				reader.Read();
				variant = reader.ReadValue<Elastic.Clients.Elasticsearch.Serverless.Core.Search.StupidBackoffSmoothingModel?>(options);
				continue;
			}
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, SmoothingModel value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		switch (value.VariantType)
		{
			case "":
				break;
			case "laplace":
				writer.WriteProperty(options, value.VariantType, (Elastic.Clients.Elasticsearch.Serverless.Core.Search.LaplaceSmoothingModel?)value.Variant);
				break;
			case "linear_interpolation":
				writer.WriteProperty(options, value.VariantType, (Elastic.Clients.Elasticsearch.Serverless.Core.Search.LinearInterpolationSmoothingModel?)value.Variant);
				break;
			case "stupid_backoff":
				writer.WriteProperty(options, value.VariantType, (Elastic.Clients.Elasticsearch.Serverless.Core.Search.StupidBackoffSmoothingModel?)value.Variant);
				break;
			default:
