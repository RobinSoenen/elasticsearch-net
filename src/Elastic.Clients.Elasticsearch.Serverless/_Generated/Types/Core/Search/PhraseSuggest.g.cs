...
internal sealed partial class PhraseSuggestConverter : System.Text.Json.Serialization.JsonConverter<PhraseSuggest>
{
	...
	public override PhraseSuggest Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
	{
		...
		LocalJsonProperty<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.Core.Search.PhraseSuggestOption>> propOptions = default;
		...
		while (reader.Read() && reader.TokenType is System.Text.Json.JsonTokenType.PropertyName)
		{
			...
			if (propOptions.TryRead(ref reader, options, PropOptions, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.Core.Search.PhraseSuggestOption>, Elastic.Clients.Elasticsearch.Serverless.Core.Search.PhraseSuggestOption>)))
			{
				continue;
			}
...
,
	...
	public override void Write(System.Text.Json.Utf8JsonWriter writer, PhraseSuggest value, System.Text.Json.JsonSerializerOptions options)
	{
		...
		writer.WriteProperty(options, PropOptions, value.Options, typeof(SingleOrManyMarker<IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.Core.Search.PhraseSuggestOption>, Elastic.Clients.Elasticsearch.Serverless.Core.Search.PhraseSuggestOption>));
...
public sealed partial class PhraseSuggest : ISuggest
{
	...
	public IReadOnlyCollection<Elastic.Clients.Elasticsearch.Serverless.Core.Search.PhraseSuggestOption> Options { get; init; }
