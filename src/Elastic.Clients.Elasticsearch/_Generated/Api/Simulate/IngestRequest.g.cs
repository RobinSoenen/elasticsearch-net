...
public sealed partial class IngestRequest : PlainRequest<IngestRequestParameters>
{
	...
	/// </para>
	/// </summary>
	[JsonInclude, JsonPropertyName("index_template_subtitutions")]
	public IDictionary<string, Elastic.Clients.Elasticsearch.IndexManagement.IndexTemplate>? IndexTemplateSubtitutions { get; set; }
...
public sealed partial class IngestRequestDescriptor<TDocument> : RequestDescriptor<IngestRequestDescriptor<TDocument>, IngestRequestParameters>
{
	...
	private IDictionary<string, Elastic.Clients.Elasticsearch.IndexManagement.IndexTemplateDescriptor<TDocument>> IndexTemplateSubtitutionsValue { get; set; }
	...
	/// </para>
	/// </summary>
	public IngestRequestDescriptor<TDocument> IndexTemplateSubtitutions(Func<FluentDescriptorDictionary<string, Elastic.Clients.Elasticsearch.IndexManagement.IndexTemplateDescriptor<TDocument>>, FluentDescriptorDictionary<string, Elastic.Clients.Elasticsearch.IndexManagement.IndexTemplateDescriptor<TDocument>>> selector)
	{
		IndexTemplateSubtitutionsValue = selector?.Invoke(new FluentDescriptorDictionary<string, Elastic.Clients.Elasticsearch.IndexManagement.IndexTemplateDescriptor<TDocument>>());
		return Self;
	}
	...
	protected override void Serialize(Utf8JsonWriter writer, JsonSerializerOptions options, IElasticsearchClientSettings settings)
	{
		...
		if (IndexTemplateSubtitutionsValue is not null)
		{
			writer.WritePropertyName("index_template_subtitutions");
			JsonSerializer.Serialize(writer, IndexTemplateSubtitutionsValue, options);
		}
...
public sealed partial class IngestRequestDescriptor : RequestDescriptor<IngestRequestDescriptor, IngestRequestParameters>
{
	...
	private Action<Elastic.Clients.Elasticsearch.Ingest.DocumentDescriptor> DocsDescriptorAction { get; set; }
	private Action<Elastic.Clients.Elasticsearch.Ingest.DocumentDescriptor>[] DocsDescriptorActions { get; set; }
	private IDictionary<string, Elastic.Clients.Elasticsearch.IndexManagement.IndexTemplateDescriptor> IndexTemplateSubtitutionsValue { get; set; }
	private Elastic.Clients.Elasticsearch.Mapping.TypeMapping? MappingAdditionValue { get; set; }
	...
	/// </para>
	/// </summary>
	public IngestRequestDescriptor IndexTemplateSubtitutions(Func<FluentDescriptorDictionary<string, Elastic.Clients.Elasticsearch.IndexManagement.IndexTemplateDescriptor>, FluentDescriptorDictionary<string, Elastic.Clients.Elasticsearch.IndexManagement.IndexTemplateDescriptor>> selector)
	{
		IndexTemplateSubtitutionsValue = selector?.Invoke(new FluentDescriptorDictionary<string, Elastic.Clients.Elasticsearch.IndexManagement.IndexTemplateDescriptor>());
		return Self;
	}
